...
{
    public class T2SubestFicha1DTO
    {
        ...
        public List<T2SubestFicha1Det1DTO> Lista1DTOs { get; set; }
        public List<T2SubestFicha1Det2DTO> Lista2DTOs { get; set; }
        public List<T2SubestFicha1Det3DTO> Lista3DTOs { get; set; }
