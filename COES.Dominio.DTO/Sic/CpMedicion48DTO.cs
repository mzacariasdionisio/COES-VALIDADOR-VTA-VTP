...
{
    /// <summary>
    /// Clase que mapea la tabla CP_MEDICION48
    /// </summary>
    public partial class CpMedicion48DTO : EntityBase
    {
        public int Recurcodi { get; set; }
        public int Srestcodi { get; set; }
    ...
    public partial class CpMedicion48DTO
    {
        public int Recurcodisicoes { get; set; }
        public int HxIni { get; set; }
        public int HxFin { get; set; }
        ...
        public bool TieneCheckCompH { get; set; }
        #endregion
