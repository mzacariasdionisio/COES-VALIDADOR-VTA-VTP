...
{
    /// <summary>
    /// Clase que mapea la tabla CP_YUPCON_M48
    /// </summary>
    public partial class CpYupconM48DTO : EntityBase
    {
        public int Dyupcodi { get; set; }
