...
{
    public class DpoMedicion96DTO
    {
        public int Dpomedcodi { get; set; }
        public int Dpotmecodi { get; set; }
        public int Dpotdtcodi { get; set; }
        public DateTime Dpomedfecha { get; set; }
        ...
        public string Dpomedusucreacion { get; set; }
        public DateTime Dpomedfeccreacion { get; set; }
        public string Dpomedusumodificacion { get; set; }
        public DateTime Dpomedfecmodificacion { get; set; }
