...
{
    public class DpoRelacionPtoBarraDTO
    {
        public int Ptobarcodi { get; set; }
        public int Splfrmcodi { get; set; }
        public int Ptomedicodi { get; set; }
        public string Ptobarusucreacion { get; set; }
        public DateTime Ptobarfeccreacion { get; set; }
        public string Ptobarusumodificacion { get; set; }
        public DateTime Ptobarfecmodificacion { get; set; }
