...
{
    /// <summary>
    /// Clase que mapea la tabla MAP_MEDICION48
    /// </summary>
    public class MapMedicion48DTO : EntityBase
    {
        public int Mediccodi { get; set; } 
        public DateTime Medicfecha { get; set; } 
        public int Tipoccodi { get; set; } 
        public int? Vermcodi { get; set; }
        public decimal? Medictotal { get; set; } 
        public decimal? Medicpromedio { get; set; } 
