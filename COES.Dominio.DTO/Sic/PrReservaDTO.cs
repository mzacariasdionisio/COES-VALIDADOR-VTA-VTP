...
{
    /// <summary>
    /// Clase que mapea la tabla PR_RESERVA
    /// </summary>
    public partial class PrReservaDTO : EntityBase
    {
        public int Prsvcodi { get; set; } 
        public string Prsvdato { get; set; } 
        public int Prsvactivo { get; set; } 
        public DateTime Prsvfechavigencia { get; set; } 
        public DateTime? Prsvfeccreacion { get; set; } 
        public string Prsvusucreacion { get; set; } 
        public DateTime? Prsvfecmodificacion { get; set; } 
        public string Prsvusumodificacion { get; set; } 
        public int Prsvtipo { get; set; } 
    }

    public partial class PrReservaDTO
    {
        //public string EstiloEstado { get; set; }
        //public bool ExisteCambio { get; set; }
        public string TipoReserva { get; set; }
        public string EstadoReserva { get; set; }
        public string PrsvfeccreacionDesc { get; set; }
        public string PrsvfecmodificacionDesc { get; set; }
        public string PrsvfechavigenciaDesc { get; set; }
