...
{
    public class PrnAgrupacionFormulasDTO
    {
        public int Prnafmcodi { get; set; }
        public int Ptomedicodi { get; set; }
        public int Prrucodi { get; set; }
        public int Prnafmprioridad { get; set; }
        public string Prnafmflagesmanual { get; set; }
        ...
        public decimal[] ArrayDatos { get; set; }
