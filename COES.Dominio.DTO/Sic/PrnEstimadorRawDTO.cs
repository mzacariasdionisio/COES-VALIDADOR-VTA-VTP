...
{
    public class PrnEstimadorRawDTO
    {
        public int Etmrawcodi { get; set; }
        public int Ptomedicodi { get; set; }
        public int Prnvarcodi { get; set; }
        public int Etmrawfuente { get; set; }
        public int Etmrawtipomedi { get; set; }
        public DateTime Etmrawfecha { get; set; }
        public decimal? Etmrawvalor { get; set; }
