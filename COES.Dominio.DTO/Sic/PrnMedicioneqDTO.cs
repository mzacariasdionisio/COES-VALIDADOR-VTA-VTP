...
{
    public class PrnMedicioneqDTO
    {
        public int Equicodi { get; set; }
        public int Prnmeqtipo { get; set; }
        public DateTime Medifecha { get; set; }
        public int Areacodi { get; set; }
        public int Prnmeqdepurar { get; set; }
        public decimal Prnmeqdejevsrpf { get; set; }
        ...
        public string Prnmequsucreacion { get; set; }
        public DateTime Prnmeqfeccreacion { get; set; }
        public string Prnmequsumodificacion { get; set; }
        public DateTime Prnmeqfecmodificacion { get; set; }
