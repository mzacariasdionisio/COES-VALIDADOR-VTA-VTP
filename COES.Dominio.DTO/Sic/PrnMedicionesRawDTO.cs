...
{
    public class PrnMedicionesRawDTO
    {
        public int Medirawcodi { get; set; }
        public int Ptomedicodi { get; set; }
        public int Prnvarcodi { get; set; }
        public string Medirawfuente { get; set; }
        public DateTime Medirawfecha { get; set; }
        public string Medirawtipomedi { get; set; }
        ...
        public string Medirawusucreacion { get; set; }
        public DateTime Medirawfeccreacion { get; set; }
        public string Medirawusumodificacion { get; set; }
        public DateTime Medirawfecmodificacion { get; set; }
