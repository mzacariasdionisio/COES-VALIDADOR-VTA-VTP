...
{
    public class PrnMediciongrpDTO
    {
        public int Grupocodi { get; set; }
        public int Prnmgrtipo { get; set; }
        ...
        public string Prnmgrusucreacion { get; set; }
        public DateTime Prnmgrfeccreacion { get; set; }
        public string Prnmgrusumodificacion { get; set; }
        public DateTime Prnmgrfecmodificacion { get; set; }
        ...
        //Prondema.E3 - 20211125
        public int Reltnaformula { get; set; }
        public int Reltnadetformula { get; set; }
        //06012022
        public int Vergrpcodi { get; set; }
        public string Vergrpnomb { get; set; }
        public string PrnmgrTraslado { get; set; }
        public int PrnmgrTrasladoCount { get; set; }
        public bool Seleccionado { get; set; }
        //Assetec 20220302
        public int Prnmgrpadre { get; set; }
    }
}
