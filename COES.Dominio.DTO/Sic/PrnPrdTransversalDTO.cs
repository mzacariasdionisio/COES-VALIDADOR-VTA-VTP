...
{
    public class PrnPrdTransversalDTO
    {
        public int Prdtrncodi { get; set; }
        public string Prdtrnetqnomb { get; set; }
        public int Grupocodi { get; set; }
        public int Prnvercodi { get; set; }
        public int Prrucodi { get; set; }
        public bool Prdtrnflagesmanual { get; set; }
        ...
        public decimal? Prdtrnperdida { get; set; }
        public string Grupocodilist { get; set; }
        
        public List<string> DataBarras { get; set; }
        public List<string> DataFormulas { get; set; }
        // ----------------------------------------------------------------------
    }
}
