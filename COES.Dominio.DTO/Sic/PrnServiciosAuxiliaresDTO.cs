...
{
    public class ServiciosAuxiliaresModel
    {
        public string Fecha { get; set; }
        public string Mensaje { get; set; }
        public string TipoMensaje { get; set; }
        public List<MePerfilRuleDTO> DtFormulasDisponibles { get; set; }
        public List<PrnServiciosAuxiliaresDTO> DtRelacionesSeleccionadas { get; set; }
        public List<string> Data { get; set; }
    }

    public class PrnServiciosAuxiliaresDTO
    {
        public int Prnauxcodi { get; set; }
        public int Grupocodi { get; set; }
        public int Prrucodi { get; set; }
        public bool Prnauxflagesmanual { get; set; }
