...
{
    /// <summary>
    /// Clase que mapea la tabla WB_RESUMENMD
    /// </summary>
    public class WbResumenmdDTO : EntityBase
    {
        public int Resmdcodi { get; set; }
        public DateTime Resmdfecha { get; set; }
        public DateTime? Resmdhora { get; set; }
        public decimal Resmdvalor { get; set; }
        public DateTime Resmdmes { get; set; }
