...
namespace COES.Dominio.Interfaces.Transferencias
{
    ...
    /// </summary>
    public interface ICpaDocumentosDetalleRepository
    {
        /// <summary>
        ...
        int Save(CpaDocumentosDetalleDTO entity);
        ...
        List<CpaDocumentosDetalleDTO> GetDetalleByDocumento(int cpadoccodi);
    }
}
