...
{
    /// <summary>
    /// Clase que contiene el mapeo de la tabla F_LECTURA_SP7
    /// </summary>
    public class FLecturaSp7Helper : HelperBase
    {
        public FLecturaSp7Helper(): base(Consultas.FLecturaSp7Sql)
        {
        }

        public FLecturaSp7DTO Create(IDataReader dr)
        {
            ...
            int iFrecspusucreacion = dr.GetOrdinal(this.Frecspusucreacion);
            if (!dr.IsDBNull(iFrecspusucreacion)) entity.Frecspusucreacion = dr.GetString(iFrecspusucreacion);

            int iFrecspfeccreacion = dr.GetOrdinal(this.Frecspfeccreacion);
            if (!dr.IsDBNull(iFrecspfeccreacion)) entity.Frecspfeccreacion = dr.GetDateTime(iFrecspfeccreacion);

            int iFrecspusumodificacion = dr.GetOrdinal(this.Frecspusumodificacion);
            if (!dr.IsDBNull(iFrecspusumodificacion)) entity.Frecspusumodificacion = dr.GetString(iFrecspusumodificacion);

            int iFrecspfecmodificacion = dr.GetOrdinal(this.Frecspfecmodificacion);
            if (!dr.IsDBNull(iFrecspfecmodificacion)) entity.Frecspfecmodificacion = dr.GetDateTime(iFrecspfecmodificacion);
        ...
        public string Frecspusucreacion = "FRECSPUSUCREACION";
        public string Frecspfeccreacion = "FRECSPFECCREACION";
        public string Frecspusumodificacion = "FRECSPUSUMODIFICACION";
        public string Frecspfecmodificacion = "FRECSPFECMODIFICACION";
        ...
        public string ObtenerListadoGrafico
        {
            get { return base.GetSqlXml("ObtenerListadoGrafico"); }
        }
        ...
        public string MaximaFrecuencia
        {
            get { return base.GetSqlXml("MaximaFrecuencia"); }
        }


        public string MinimaFrecuencia
        {
            get { return base.GetSqlXml("MinimaFrecuencia"); }
        }

        public string SubitaFrecuencia
        {
            get { return base.GetSqlXml("SubitaFrecuencia"); }
        }

        public string TramaFrecuencia
        {
            get { return base.GetSqlXml("TramaFrecuencia"); }
        }
        ...
        #region FIT - SGOCOES fun A - Web Service to Add In
        public string SqlGetFromTablaFrecuenciaWithZeroH
        {
            get { return base.GetSqlXml("GetFromTablaFrecuenciaWithZeroH"); }
        }
        public string SqlGetFromTablaFrecuencia
        {
            get { return base.GetSqlXml("GetFromTablaFrecuencia"); }
        }
