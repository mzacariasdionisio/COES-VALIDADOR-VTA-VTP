...
{
    /// <summary>
    /// Clase que contiene el mapeo de la tabla CM_VOLUMEN_DETALLE
    /// </summary>
    public class CmVolumenDetalleHelper : HelperBase
    {
        public CmVolumenDetalleHelper() : base(Consultas.CmVolumenDetalleSql)
        {
        }

        public CmVolumenDetalleDTO Create(IDataReader dr)
        {
            CmVolumenDetalleDTO entity = new CmVolumenDetalleDTO();
            ...
            int iVoldetcodi = dr.GetOrdinal(this.Voldetcodi);
            if (!dr.IsDBNull(iVoldetcodi)) entity.Voldetcodi = Convert.ToInt32(dr.GetValue(iVoldetcodi));
        ...
        public string Voldetcodi = "VOLDETCODI";
