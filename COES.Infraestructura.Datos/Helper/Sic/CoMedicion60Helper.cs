...
{
    /// <summary>
    /// Clase que contiene el mapeo de la tabla CO_MEDICION60
    /// </summary>
    public class CoMedicion60Helper : HelperBase
    {
        public CoMedicion60Helper(): base(Consultas.CoMedicion60Sql)
        {
        }

        public CoMedicion60DTO Create(IDataReader dr)
        {
            ...
            int iComedicodi = dr.GetOrdinal(this.Comedicodi);
            if (!dr.IsDBNull(iComedicodi)) entity.Comedicodi = Convert.ToInt32(dr.GetValue(iComedicodi));
            ...
            int iComedihora = dr.GetOrdinal(this.Comedihora);
            if (!dr.IsDBNull(iComedihora)) entity.Comedihora = Convert.ToInt32(dr.GetValue(iComedihora));

            int iComediminuto = dr.GetOrdinal(this.Comediminuto);
            if (!dr.IsDBNull(iComediminuto)) entity.Comediminuto = Convert.ToInt32(dr.GetValue(iComediminuto));

            int iComeditipo = dr.GetOrdinal(this.Comeditipo);
            if (!dr.IsDBNull(iComeditipo)) entity.Comeditipo = Convert.ToInt32(dr.GetValue(iComeditipo));
        ...
        public string Comedicodi = "COMEDICODI";
        public string Prodiacodi = "PRODIACODI";
        public string Cotidacodi = "COTIDACODI";
        public string Grupocodi = "GRUPOCODI";
        public string Equicodi = "EQUICODI";
        public string Canalcodi = "CANALCODI";
        public string Comedihora = "COMEDIHORA";
        public string Comediminuto = "COMEDIMINUTO";
        public string Comeditipo = "COMEDITIPO";
        public string H1 = "H1";
        public string H2 = "H2";
        public string H3 = "H3";
        public string H4 = "H4";
        ...
        public string TableName = "CO_MEDICION60";

        #endregion

        public string SqlListarUltimoMinutoPorRango
        {
            get { return base.GetSqlXml("ListarUltimoMinutoPorRango"); }
        }

        public string SqlListarUltimoMinutoDiaAnteriorMuchasTablas
        {
            get { return base.GetSqlXml("ListarUltimoMinutoDiaAnteriorMuchasTablas"); }
        }
        
        

        public string SqlEliminarMedicion60XTabla
        {
            get { return base.GetSqlXml("EliminarMedicion60XTabla"); }
        }
        
        public string SqlObtenerDataReporte
        {
            get { return base.GetSqlXml("ObtenerDataReporte"); }
        }

        public string SqlObtenerDataReporteFP
        {
            get { return base.GetSqlXml("ObtenerDataReporteFP"); }
        }

        public string SqlObtenerDataReporteFU
        {
            get { return base.GetSqlXml("ObtenerDataReporteFU"); }
        }

        //CREACIÓN DE TABLAS
        public string SqlCrearTabla
        {
            get { return base.GetSqlXml("CrearTabla"); }
        }
        public string SqlCrearIndex
        {
            get { return base.GetSqlXml("CrearIndex"); }
        }
        public string SqlCrearPKMedicion60
        {
            get { return base.GetSqlXml("CrearPKMedicion60"); }
        }
        public string SqlCrearFKProcesoDiario
        {
            get { return base.GetSqlXml("CrearFKProcesoDiario"); }
        }
        public string SqlCrearFKGrupo
        {
            get { return base.GetSqlXml("CrearFKGrupo"); }
        }
        public string SqlCrearFKEquipo
        {
            get { return base.GetSqlXml("CrearFKEquipo"); }
        }
        public string SqlCrearFKTipoDato
        {
            get { return base.GetSqlXml("CrearFKTipoDato"); }
        }
        public string SqlCrearFKCanalSP7
        {
            get { return base.GetSqlXml("CrearFKCanalSP7"); }
        }
        public string SqlCrearIndiceBusueda
        {
            get { return base.GetSqlXml("CrearIndiceBusqueda"); }
        }
        ...
        public string SqlEliminarTodaDataMed60
        {
            get { return base.GetSqlXml("EliminarTodaDataMed60"); }
        }

        public string SqlObtenerIdInicial
        {
            get { return base.GetSqlXml("ObtenerIdInicial"); }
        }


        public string SqlVerificarExisttenciaTabla
        {
            get { return base.GetSqlXml("VerificarExisttenciaTabla"); }
        }

        public string SqlGetInformacionAGC
        {
            get { return base.GetSqlXml("GetInformacionAGC"); }
        }

        public string SqlProcesarTabla
        {
            get { return base.GetSqlXml("ProcesarTabla"); }
        }
    }
}
