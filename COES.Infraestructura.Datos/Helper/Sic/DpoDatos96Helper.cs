...
namespace COES.Infraestructura.Datos.Helper.Sic
{
    public class DpoDatos96Helper : HelperBase
    {
        ...
        public string Dpodatsubcodi = "DPODATSUBCODI";
        public string Dpodattnfcodi = "DPODATTNFCODI";
        public string Dpodattnfserie = "DPODATTNFSERIE";
        public string Dpodatbarcodi = "DPODATBARCODI";
        public string Dpodattipocodi = "DPODATTIPOCODI";
        public string Dpodatfecha = "DPODATFECHA";
        public string H1 = "H1";
        public string H2 = "H2";
        public string H3 = "H3";
        public string H4 = "H4";
        ...
        public string SqlListTrafoBarraInfo
        {
            get { return GetSqlXml("ListTrafoBarraInfo"); }
        }
        public string SqlDeleteBetweenDates
        {
            get { return base.GetSqlXml("DeleteBetweenDates"); }
        }
        public string SqlListBetweenDates
        {
            get { return base.GetSqlXml("ListBetweenDates"); }
        }
        public string SqlListMedidorDemandaSirpit
        {
            get { return base.GetSqlXml("ListMedidorDemandaSirpit"); }
        }
        public string SqlListGroupByMonthYear
        {
            get { return base.GetSqlXml("ListGroupByMonthYear"); }
        }
        public string SqlListDatosSIRPIT
        {
            get { return base.GetSqlXml("ListDatosSIRPIT"); }
        }
        public string SqlListAllBetweenDates
        {
            get { return base.GetSqlXml("ListAllBetweenDates"); }
        }
        public string SqlListSirpitByDateRange
        {
            get { return base.GetSqlXml("ListSirpitByDateRange"); }
        }
        public string SqlObtenerDemandaSirpit
        {
            get { return base.GetSqlXml("ObtenerDemandaSirpit"); }
        }
    }
}
