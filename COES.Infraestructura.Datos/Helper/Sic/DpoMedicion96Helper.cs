...
{
    public class DpoMedicion96Helper : HelperBase
    {
        public DpoMedicion96Helper() : base(Consultas.DpoMedicion96Sql)
        {
        }

        public DpoMedicion96DTO Create(IDataReader dr)
        {
            DpoMedicion96DTO entity = new DpoMedicion96DTO();

            int iDpomedcodi = dr.GetOrdinal(this.Dpomedcodi);
            if (!dr.IsDBNull(iDpomedcodi)) entity.Dpomedcodi = Convert.ToInt32(dr.GetValue(iDpomedcodi));

            int iDpotmecodi = dr.GetOrdinal(this.Dpotmecodi);
            if (!dr.IsDBNull(iDpotmecodi)) entity.Dpotmecodi = Convert.ToInt32(dr.GetValue(iDpotmecodi));

            int iDpotdtcodi = dr.GetOrdinal(this.Dpotdtcodi);
            if (!dr.IsDBNull(iDpotdtcodi)) entity.Dpotdtcodi = Convert.ToInt32(dr.GetValue(iDpotdtcodi));

            int iDpomedfecha = dr.GetOrdinal(this.Dpomedfecha);
        ...
        public void GetH1To96(IDataReader dr, DpoMedicion96DTO entity)
        {
        ...
        public string Dpomedcodi = "DPOMEDCODI";
        public string Dpotmecodi = "DPOTMECODI";
        public string Dpotdtcodi = "DPOTDTCODI";
        public string Dpomedfecha = "DPOMEDFECHA";
        ...
        public string Dpomedusucreacion = "DPOMEDUSUCREACION";
        public string Dpomedfeccreacion = "DPOMEDFECCREACION";
        public string Dpomedusumodificacion = "DPOMEDUSUMODIFICACION";
        public string Dpomedfecmodificacion = "DPOMEDFECMODIFICACION";
        ...
        public string SqlListByVersion
        {
            get { return base.GetSqlXml("ListByVersion"); }
        }
        ...
        public string SqlObtenerVersionComparacion
        {
            get { return base.GetSqlXml("ObtenerVersionComparacion"); }
        }
        public string SqlObtenerDatosMediciongrp
        {
            get { return base.GetSqlXml("ObtenerDatosMediciongrp"); }
        }
        public string SqlObtenerDatosPorVersion
        {
            get { return base.GetSqlXml("ObtenerDatosPorVersion"); }
        }
        public string SqlObtenerDatosPorVersionNulleable
        {
            get { return base.GetSqlXml("ObtenerDatosPorVersionNulleable"); }
        }
        public string SqlObtenerDatosPorId
        {
            get { return base.GetSqlXml("ObtenerDatosPorId"); }
        }
        public string SqlObtenerDatosAgrupados
        {
            get { return base.GetSqlXml("ObtenerDatosAgrupados"); }
        }
        public string SqlObtenerDatosCompAgrupados
        {
            get { return base.GetSqlXml("ObtenerDatosCompAgrupados"); }
        }
        public string SqlObtenerDemRDOPrevExtranet
        {
            get { return base.GetSqlXml("ObtenerDemRDOPrevExtranet"); }
        }
        public string SqlObtenerDatosEscenarioYupana
        {
            get { return base.GetSqlXml("ObtenerDatosEscenarioYupana"); }
        }
        public string SqlObtenerDatosSumEscenarioYupana
        {
            get { return base.GetSqlXml("ObtenerDatosSumEscenarioYupana"); }
        }
        public string SqlObtenerDatosFormulaM48
        {
            get { return base.GetSqlXml("ObtenerDatosFormulaM48"); }
        }
        public string SqlObtenerDatosMedicion48
        {
            get { return base.GetSqlXml("ObtenerDatosMedicion48"); }
        }
        #endregion
