...
namespace COES.Infraestructura.Datos.Helper.Sic
{
    ...
    public class MeFormatoHelper : HelperBase
    {
        ...
        public MeFormatoDTO Create(IDataReader dr)
        {
            ...
            int iFormatenviocheckadicional = dr.GetOrdinal(this.Formatenviocheckadicional);
            if (!dr.IsDBNull(iFormatenviocheckadicional)) entity.Formatenviocheckadicional = dr.GetString(iFormatenviocheckadicional);
        ...
        public string Formatenviocheckadicional = "FORMATENVIOCHECKADICIONAL";
