...
{
    /// <summary>
    /// Clase que contiene el mapeo de la tabla ME_MEDICION60
    /// </summary>
    public class MeMedicion60Helper : HelperBase
    {
        public MeMedicion60Helper(): base(Consultas.MeMedicion60Sql)
        {
        }

        public MeMedicion60DTO Create(IDataReader dr)
        {
        ...
        public string POTENCIA = "POTENCIA";
        public string FRECUENCIA = "FRECUENCIA";
        public string TableName = "ME_MEDICION60";

        #endregion

        public string SqlVerificarCarga
        {
            get { return base.GetSqlXml("VerificarCarga"); }
        }

        public string SqlConsultaDescarga
        {
            get { return base.GetSqlXml("ConsultaDescarga"); }
        }

        public string SqlObtenerPotencia
        {
            get { return base.GetSqlXml("ObtenerPotencia"); }
        }

        public string SqlObtenerRango
        {
            get { return base.GetSqlXml("ObtenerRango"); }
        }

        public string SqlObtenerDatosComparacionRangoResolucionCuartoHora
        {
            get { return base.GetSqlXml("ObtenerDatosComparacionRangoResolucionCuartoHora"); }
        }

        public string SqlObtenerDatosComparacionRango
        {
            get { return base.GetSqlXml("ObtenerDatosComparacionRango"); }
        }

        public string SqlObtenerDatosComparacionRangoResolucionHora
        {
            get { return base.GetSqlXml("ObtenerDatosComparacionRangoResolucionHora"); }
        }

        public string SqlObtenerPotenciasMaximas
        {
            get { return base.GetSqlXml("ObtenerPotenciasMaximas"); }
        }
        ...
        public string SqlEliminarReporte
        {
            get { return base.GetSqlXml("EliminarReporte"); }
        }

        public string SqlGrabarReporte
        {
            get { return base.GetSqlXml("GrabarReporte"); }
        }

        public string SqlGrabarLogReporte
        {
            get { return base.GetSqlXml("GrabarLog"); }
        }

        public string SqlListaMedicionesTmp
        {
            get { return base.GetSqlXml("ListaMedicionesTmp"); }
        }

        public string SqlEliminarCargaRpf
        {
            get { return base.GetSqlXml("EliminarCargaRpf"); }
        }

        public string SqlBuscarDatosRpf
        {
            get { return base.GetSqlXml("BuscarDatosRpf"); }
        }

        public string SqlGrabarLogReporteEnvio
        {
            get { return base.GetSqlXml("GrabarLogReporte"); }
        }

        public string SqlGetMaxIdLogReporteEnvio
        {
            get { return base.GetSqlXml("GetMaxIdLogReporteEnvio"); }
        }
		
        #region Generar FileZip Pr21
        public string SqlDescargarDatos
        {
            get { return base.GetSqlXml("DescargarDatos"); }
        }
        #endregion
    }
}
