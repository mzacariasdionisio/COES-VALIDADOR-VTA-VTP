...
{
    public class PrnAgrupacionFormulasHelper : HelperBase
    {
        public PrnAgrupacionFormulasHelper() : base(Consultas.PrnAgrupacionFormulasSql)
        {
        }

        public PrnAgrupacionFormulasDTO Create(IDataReader dr)
        {
            PrnAgrupacionFormulasDTO entity = new PrnAgrupacionFormulasDTO();

            int iPrnafmcodi = dr.GetOrdinal(this.Prnafmcodi);
            ...
            int iPrnafmprioridad = dr.GetOrdinal(this.Prnafmprioridad);
            if (!dr.IsDBNull(iPrnafmprioridad)) entity.Prnafmprioridad = Convert.ToInt32(dr.GetValue(iPrnafmprioridad));

            int iPrnafmflagesmanual = dr.GetOrdinal(this.Prnafmflagesmanual);
        ...
        public string Prnafmcodi = "PRNAFMCODI";
        public string Ptomedicodi = "PTOMEDICODI"; 
        public string Prrucodi = "PRRUCODI";
        public string Prruabrev = "PRRUABREV";
        public string Prnafmprioridad = "PRNAFMPRIORIDAD";
        public string Prnafmflagesmanual = "PRNAFMFLAGESMANUAL";
        public string H1 = "H1";
        public string H2 = "H2";
        public string H3 = "H3";
        public string H4 = "H4";
        ...
        public string SqlGetListAgrupacionFormulasByAgrupacion
        {
            get { return base.GetSqlXml("ListAgrupacionFormulasByAgrupacion"); }
        }
