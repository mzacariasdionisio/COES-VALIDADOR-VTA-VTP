...
{
    public class PrnMedicioneqHelper : HelperBase
    {
        public PrnMedicioneqHelper()
            : base(Consultas.PrnMedicioneqSql)
        {
        }

        public PrnMedicioneqDTO Create(IDataReader dr)
        {
            ...
            int iPrnmeqtipo = dr.GetOrdinal(this.Prnmeqtipo);
            if (!dr.IsDBNull(iPrnmeqtipo)) entity.Prnmeqtipo = dr.GetInt32(iPrnmeqtipo);
            ...
            int iPrnmeqdepurar = dr.GetOrdinal(this.Prnmeqdepurar);
            if (!dr.IsDBNull(iPrnmeqdepurar)) entity.Prnmeqdepurar = dr.GetInt32(iPrnmeqdepurar);

            int iPrnmeqdejevsrpf = dr.GetOrdinal(this.Prnmeqdejevsrpf);
            if (!dr.IsDBNull(iPrnmeqdejevsrpf)) entity.Prnmeqdejevsrpf = dr.GetDecimal(iPrnmeqdejevsrpf);
            ...
            int iPrnmequsucreacion = dr.GetOrdinal(this.Prnmequsucreacion);
            if (!dr.IsDBNull(iPrnmequsucreacion)) entity.Prnmequsucreacion = dr.GetString(iPrnmequsucreacion);

            int iPrnmeqfeccreacion = dr.GetOrdinal(this.Prnmeqfeccreacion);
            if (!dr.IsDBNull(iPrnmeqfeccreacion)) entity.Prnmeqfeccreacion = dr.GetDateTime(iPrnmeqfeccreacion);

            int iPrnmequsumodificacion = dr.GetOrdinal(this.Prnmequsumodificacion);
            if (!dr.IsDBNull(iPrnmequsumodificacion)) entity.Prnmequsumodificacion = dr.GetString(iPrnmequsumodificacion);

            int iPrnmeqfecmodificacion = dr.GetOrdinal(this.Prnmeqfecmodificacion);
            if (!dr.IsDBNull(iPrnmeqfecmodificacion)) entity.Prnmeqfecmodificacion = dr.GetDateTime(iPrnmeqfecmodificacion);
        ...
        public string Prnmeqtipo = "PRNMEQTIPO";
        public string Medifecha = "MEDIFECHA";
        public string Areacodi = "AREACODI";
        public string Prnmeqdepurar = "PRNMEQDEPURAR";
        public string Prnmeqdejevsrpf = "PRNMEQDEJEVSRPF";
        public string H1 = "H1";
        public string H2 = "H2";
        public string H3 = "H3";
        public string H4 = "H4";
        ...
        public string Prnmequsucreacion = "PRNMEQUSUCREACION";
        public string Prnmeqfeccreacion = "PRNMEQFECCREACION";
        public string Prnmequsumodificacion = "PRNMEQUSUMODIFICACION";
        public string Prnmeqfecmodificacion = "PRNMEQFECMODIFICACION";
        //Atributos de consulta
        public string Fecha = "FECHA"; //formato DD/MM/YYY
        ...
        public string SqlObtenerPuntosFaltantes
        {
            get { return base.GetSqlXml("ObtenerPuntosFaltantes"); }
        }
