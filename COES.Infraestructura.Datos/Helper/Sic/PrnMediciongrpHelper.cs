...
{
    public class PrnMediciongrpHelper : HelperBase
    {
        public PrnMediciongrpHelper() : base(Consultas.PrnMediciongrpSql)
        {
        }

        public PrnMediciongrpDTO Create(IDataReader dr)
        {
            ...
            int iPrnmgrtipo = dr.GetOrdinal(this.Prnmgrtipo);
            ...
            int iPrnmgrusucreacion = dr.GetOrdinal(this.Prnmgrusucreacion);
            if (!dr.IsDBNull(iPrnmgrusucreacion)) entity.Prnmgrusucreacion = dr.GetString(iPrnmgrusucreacion);

            int iPrnmgrfeccreacion = dr.GetOrdinal(this.Prnmgrfeccreacion);
            if (!dr.IsDBNull(iPrnmgrfeccreacion)) entity.Prnmgrfeccreacion = dr.GetDateTime(iPrnmgrfeccreacion);

            int iPrnmgrusumodificacion = dr.GetOrdinal(this.Prnmgrusumodificacion);
            if (!dr.IsDBNull(iPrnmgrusumodificacion)) entity.Prnmgrusumodificacion = dr.GetString(iPrnmgrusumodificacion);

            int iPrnmgrfecmodificacion = dr.GetOrdinal(this.Prnmgrfecmodificacion);
            if (!dr.IsDBNull(iPrnmgrfecmodificacion)) entity.Prnmgrfecmodificacion = dr.GetDateTime(iPrnmgrfecmodificacion);
        ...
        public string Prnmgrpadre = "PRNMGRPADRE";
        ...
        public string SqlGetDemandaBarraByArea
        {
            get { return base.GetSqlXml("GetDemandaBarraByArea"); }
        }
        ...
        public string SqlGetReportePronosticoBarraTotal
        {
            get { return base.GetSqlXml("GetReportePronosticoBarraTotal"); }
        }

        public string SqlGetReportePronosticoBarraDetalle
        {
            get { return base.GetSqlXml("GetReportePronosticoBarraDetalle"); }
        }

        /// <summary>
        ///  Formato Demanda CP
        /// </summary>
        public string SqlGetListFormatoDemandaCP
        {
            get { return base.GetSqlXml("GetListFormatoDemandaCP"); }
        }

        public string SqlValidarEjecucionPronosticoPorBarras
        {
            get { return base.GetSqlXml("ValidarEjecucionPronosticoPorBarras"); }
        }

        public string SqlPronosticoPorBarrasDuplicarVersion
        {
            get { return base.GetSqlXml("PronosticoPorBarrasDuplicarVersion"); }
        }
        public string SqlEliminarVersion
        {
            get { return base.GetSqlXml("EliminarVersion"); }
        }
        public string SqlObtenerUnidadesPorId
        {
            get { return base.GetSqlXml("ObtenerUnidadesPorId"); }
        }
        public string SqlListUnidadesEstimadorByTipo
        {
            get { return base.GetSqlXml("ListUnidadesEstimadorByTipo"); }
        }

        //Assetec 20220309
        public string SqlGetMedicionByAgrupacion
        {
            get { return base.GetSqlXml("GetMedicionByAgrupacion"); }
        }

        public string SqlGetMedicionByAgrupacionAjuste
        {
            get { return base.GetSqlXml("GetMedicionByAgrupacionAjuste"); }
        }

        public string SqlGetMedicionByBarraAjuste
        {
            get { return base.GetSqlXml("GetMedicionByBarraAjuste"); }
        }

        public string SqlGetMedicionAgrupacionByBarra
        {
            get { return base.GetSqlXml("GetMedicionAgrupacionByBarra"); }
        }

        public string SqlGetMedicionBarrasOtraAgrupacion
        {
            get { return base.GetSqlXml("GetMedicionBarrasOtraAgrupacion"); }
        }

        public string SqlGetDemandaBarraByAreaVersion
        {
            get { return base.GetSqlXml("GetDemandaBarraByAreaVersion"); }
        }

        public string SqlGetDemandaBarraByAreaTipo
        {
            get { return base.GetSqlXml("GetDemandaBarraByAreaTipo"); }
        }
    }
}
