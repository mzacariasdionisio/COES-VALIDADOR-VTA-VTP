...
{
    internal class PrnPerfilBarraHelper : HelperBase
    {
        public PrnPerfilBarraHelper() : base(Consultas.PrnPerfilBarraSql)
        {
        }

        public PrnPerfilBarraDTO Create(IDataReader dr)
        {
            PrnPerfilBarraDTO entity = new PrnPerfilBarraDTO();

            int iPrfbarcodi = dr.GetOrdinal(this.Prfbarcodi);
            if (!dr.IsDBNull(iPrfbarcodi)) entity.Prfbarcodi = Convert.ToInt32(dr.GetValue(iPrfbarcodi));
            ...
            int iPrfbartipodia = dr.GetOrdinal(this.Prfbartipodia);
            if (!dr.IsDBNull(iPrfbartipodia)) entity.Prfbartipodia = dr.GetString(iPrfbartipodia);
        ...
        public string Prfbarcodi = "PRFBARCODI";
        public string Reltnacodi = "RELTNACODI";
        public string Prfbartipodia = "PRFBARTIPODIA";
        public string H1 = "H1";
        public string H2 = "H2";
        public string H3 = "H3";
        public string H4 = "H4";
        ...
        {
            get { return base.GetSqlXml("GetByIds"); }
        }
        #endregion
    }
}
