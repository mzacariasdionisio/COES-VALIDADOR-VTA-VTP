...
{
    public class PrnPrdTransversalHelper : HelperBase
    {
        public PrnPrdTransversalHelper() : base(Consultas.PrnPrdTransversalSql)
        {

        }

        public PrnPrdTransversalDTO Create(IDataReader dr) 
        {
            PrnPrdTransversalDTO entity = new PrnPrdTransversalDTO();


            int iPrdtrncodi = dr.GetOrdinal(this.Prdtrncodi);
            if (!dr.IsDBNull(iPrdtrncodi)) entity.Prdtrncodi = Convert.ToInt32(dr.GetValue(iPrdtrncodi));

            int iPrdtrnetqnomb = dr.GetOrdinal(this.Prdtrnetqnomb);
            ...
            int iFlagesManual = dr.GetOrdinal(this.Prdtrnflagesmanual);
        ...
        public string Prdtrnflagesmanual = "PRDTRNFLAGESMANUAL";
        ...
        public string SqlGetRelacionesPorNombre
        {
            get { return base.GetSqlXml("GetRelacionesPorNombre"); }
        }
        public string SqlGetPerdidaPorBarraCP
        {
            get { return base.GetSqlXml("GetPerdidaPorBarraCP"); }
        }
        public string SqlDeleteByName
        {
            get { return base.GetSqlXml("DeleteByName"); }
        }
        ...
        public string SqlListPerdidasTransvBarraFormulas
        {
            get { return base.GetSqlXml("ListPerdidasTransvBarraFormulas"); }
        }
        
        public string SqlListBarrasPerdidasTransversales
        {
            get { return base.GetSqlXml("ListBarrasPerdidasTransversales"); }
        }

        public string SqlGetPerdidasTransversalesByNombre
        {
            get { return base.GetSqlXml("GetPerdidasTransversalesByNombre"); }
        }
        ...
        public string SqlObtenerPerdidaPorBarraCP
        {
            get { return base.GetSqlXml("ObtenerPerdidaPorBarraCP"); }
        }
        // ---------------------------------------------------------------------------------------------------------------
        #endregion
    }
