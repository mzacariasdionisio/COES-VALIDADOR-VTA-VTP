...
{
    /// <summary>
    /// Clase que contiene el mapeo de la tabla RPF_MEDICION60
    /// </summary>
    public class RpfMedicion60Helper : HelperBase
    {
        public RpfMedicion60Helper(): base(Consultas.RpfMedicion60Sql)
        {
        }

        public RpfMedicion60DTO Create(IDataReader dr)
        {
            RpfMedicion60DTO entity = new RpfMedicion60DTO();

            int iRpfmedcodi = dr.GetOrdinal(this.Rpfmedcodi);
            if (!dr.IsDBNull(iRpfmedcodi)) entity.Rpfmedcodi = Convert.ToInt32(dr.GetValue(iRpfmedcodi));
            ...
            int iRpfmedfecha = dr.GetOrdinal(this.Rpfmedfecha);
            if (!dr.IsDBNull(iRpfmedfecha)) entity.Rpfmedfecha = dr.GetDateTime(iRpfmedfecha);
        ...
        public string SqlVerificarExistenciaTabla
        {
            get { return base.GetSqlXml("VerificarExistenciaTabla"); }
        }
        ...
        public string SqlCrearFKEnvio
        {
            get { return base.GetSqlXml("CrearFKEnvio"); }
        }
        ...
        public string SqlObtenerMaxId
        {
            get { return base.GetSqlXml("ObtenerMaxId"); }
        }
