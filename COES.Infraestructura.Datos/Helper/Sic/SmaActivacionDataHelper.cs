...
{
    /// <summary>
    /// Clase que contiene el mapeo de la tabla SMA_ACTIVACION_DATA
    /// </summary>
    public class SmaActivacionDataHelper : HelperBase
    {
        public SmaActivacionDataHelper(): base(Consultas.SmaActivacionDataSql)
        {
        }

        public SmaActivacionDataDTO Create(IDataReader dr)
        {
            SmaActivacionDataDTO entity = new SmaActivacionDataDTO();

            int iSmaacdcodi = dr.GetOrdinal(this.Smaacdcodi);
            if (!dr.IsDBNull(iSmaacdcodi)) entity.Smaacdcodi = Convert.ToInt32(dr.GetValue(iSmaacdcodi));
            ...
            int iSmaacdtipodato = dr.GetOrdinal(this.Smaacdtipodato);
            if (!dr.IsDBNull(iSmaacdtipodato)) entity.Smaacdtipodato = dr.GetString(iSmaacdtipodato);

            int iSmaacdtiporeserva = dr.GetOrdinal(this.Smaacdtiporeserva);
            if (!dr.IsDBNull(iSmaacdtiporeserva)) entity.Smaacdtiporeserva = dr.GetString(iSmaacdtiporeserva);
            ...
            int iSmaacdusucreacion = dr.GetOrdinal(this.Smaacdusucreacion);
            if (!dr.IsDBNull(iSmaacdusucreacion)) entity.Smaacdusucreacion = dr.GetString(iSmaacdusucreacion);

            int iSmaacdfeccreacion = dr.GetOrdinal(this.Smaacdfeccreacion);
            if (!dr.IsDBNull(iSmaacdfeccreacion)) entity.Smaacdfeccreacion = dr.GetDateTime(iSmaacdfeccreacion);

            int iSmaacdusumodificacion = dr.GetOrdinal(this.Smaacdusumodificacion);
            if (!dr.IsDBNull(iSmaacdusumodificacion)) entity.Smaacdusumodificacion = dr.GetString(iSmaacdusumodificacion);

            int iSmaacdfecmodificacion = dr.GetOrdinal(this.Smaacdfecmodificacion);
            if (!dr.IsDBNull(iSmaacdfecmodificacion)) entity.Smaacdfecmodificacion = dr.GetDateTime(iSmaacdfecmodificacion);
        ...
        public string Smaacdcodi = "SMAACDCODI";
        public string Smapaccodi = "SMAPACCODI";
        public string Smaacdtipodato = "SMAACDTIPODATO";
        public string Smaacdtiporeserva = "SMAACDTIPORESERVA";
        public string H1 = "H1";
        public string H2 = "H2";
        public string H3 = "H3";
        public string H4 = "H4";
        ...
        public string Smaacdusucreacion = "SMAACDUSUCREACION";
        public string Smaacdfeccreacion = "SMAACDFECCREACION";
        public string Smaacdusumodificacion = "SMAACDUSUMODIFICACION";
        public string Smaacdfecmodificacion = "SMAACDFECMODIFICACION";
