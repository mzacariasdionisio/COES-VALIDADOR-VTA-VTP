...
{
    public class CamItcdf116Repository : RepositoryBase, ICamItcdf116Repository
    {
        public CamItcdf116Repository(string strConn) : base(strConn) { }

        CamItcdf116Helper Helper = new CamItcdf116Helper();

        public List<Itcdf116DTO> GetItcdf116Codi(int proyCodi)
        {
            List<Itcdf116DTO> itcdf116DTOs = new List<Itcdf116DTO>();
            DbCommand command = dbProvider.GetSqlStringCommand(Helper.SqlGetItcdf116Codi);
            ...
            using (IDataReader dr = dbProvider.ExecuteReader(command))
            {
                while (dr.Read())
                {
                    Itcdf116DTO ob = new Itcdf116DTO();
                    ...
                    ob.NombreCliente = !dr.IsDBNull(dr.GetOrdinal("NOMBRECLIENTE")) ? dr.GetString(dr.GetOrdinal("NOMBRECLIENTE")) : "";
        ...
        {
            DbCommand dbCommand = dbProvider.GetSqlStringCommand(Helper.SqlSaveItcdf116);
            dbProvider.AddInParameter(dbCommand, "ITCDF116CODI", DbType.Int32, itcdf116DTO.Itcdf116Codi);
            dbProvider.AddInParameter(dbCommand, "PROYCODI", DbType.Int32, itcdf116DTO.ProyCodi);
            dbProvider.AddInParameter(dbCommand, "AREADEMANDA", DbType.String, itcdf116DTO.AreaDemanda);
            dbProvider.AddInParameter(dbCommand, "SISTEMA", DbType.String, itcdf116DTO.Sistema);
            dbProvider.AddInParameter(dbCommand, "SUBESTACION", DbType.String, itcdf116DTO.Subestacion);
            dbProvider.AddInParameter(dbCommand, "TENSION", DbType.Decimal, itcdf116DTO.Tension);
            dbProvider.AddInParameter(dbCommand, "BARRA", DbType.String, itcdf116DTO.Barra);
            dbProvider.AddInParameter(dbCommand, "NOMBRECLIENTE", DbType.String, itcdf116DTO.NombreCliente);
            dbProvider.AddInParameter(dbCommand, "IDCARGA", DbType.String, itcdf116DTO.IdCarga);
            dbProvider.AddInParameter(dbCommand, "USU_CREACION", DbType.String, itcdf116DTO.UsuCreacion);
            dbProvider.AddInParameter(dbCommand, "FEC_CREACION", DbType.DateTime, DateTime.Now);
            dbProvider.AddInParameter(dbCommand, "IND_DEL", DbType.String, itcdf116DTO.IndDel);
        ...
        {
            DbCommand command = dbProvider.GetSqlStringCommand(Helper.SqlDeleteItcdf116ById);
        ...
        {
            int count = 0;
            DbCommand command = dbProvider.GetSqlStringCommand(Helper.SqlGetLastItcdf116Id);
        ...
        public List<Itcdf116DTO> GetItcdf116ById(int id)
        {
            ...
            DbCommand commandHoja = dbProvider.GetSqlStringCommand(Helper.SqlGetItcdf116ById);
        ...
        {
            DbCommand dbCommand = dbProvider.GetSqlStringCommand(Helper.SqlUpdateItcdf116);
            dbProvider.AddInParameter(dbCommand, "PROYCODI", DbType.Int32, itcdf116DTO.ProyCodi);
            dbProvider.AddInParameter(dbCommand, "AREADEMANDA", DbType.String, itcdf116DTO.AreaDemanda);
            dbProvider.AddInParameter(dbCommand, "SISTEMA", DbType.String, itcdf116DTO.Sistema);
            dbProvider.AddInParameter(dbCommand, "SUBESTACION", DbType.String, itcdf116DTO.Subestacion);
            ...
            dbProvider.AddInParameter(dbCommand, "NOMBRECLIENTE", DbType.String, itcdf116DTO.NombreCliente);
            dbProvider.AddInParameter(dbCommand, "IDCARGA", DbType.String, itcdf116DTO.IdCarga);
            dbProvider.AddInParameter(dbCommand, "USU_MODIFICACION", DbType.String, itcdf116DTO.UsuModificacion);
            dbProvider.AddInParameter(dbCommand, "FEC_MODIFICACION", DbType.DateTime, itcdf116DTO.FecModificacion);
            dbProvider.AddInParameter(dbCommand, "ITCDF116CODI", DbType.Int32, itcdf116DTO.Itcdf116Codi);
        ...
        public List<Itcdf116DTO> GetItcdf116ByFilter(string plancodi, string empresa, string estado)
        {
            ...
            string query = $@"
                ...
                ORDER BY TR.PLANCODI, CGB.PROYCODI,PL.CODEMPRESA, CGB.ITCDF116CODI ASC";
