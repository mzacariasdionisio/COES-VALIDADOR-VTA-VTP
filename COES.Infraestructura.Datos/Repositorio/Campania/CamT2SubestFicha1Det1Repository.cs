...
{
    public class CamT2SubestFicha1Det1Repository : RepositoryBase, ICamT2SubestFicha1Det1Repository
    {
        public CamT2SubestFicha1Det1Repository(string strConn) : base(strConn) { }

        CamT2SubestFicha1Det1Helper Helper = new CamT2SubestFicha1Det1Helper();

        public List<T2SubestFicha1Det1DTO> GetT2SubestFicha1Det1(int idcodi)
        {
            List<T2SubestFicha1Det1DTO> subestFicha1DTOs = new List<T2SubestFicha1Det1DTO>();
            DbCommand command = dbProvider.GetSqlStringCommand(Helper.SqlGetT2SubestFicha1Det1 );
            ...
            using (IDataReader dr = dbProvider.ExecuteReader(command))
            {
                while (dr.Read())
                {
                    T2SubestFicha1Det1DTO dto = new T2SubestFicha1Det1DTO();
        ...
        public bool SaveT2SubestFicha1Det1(T2SubestFicha1Det1DTO subestFicha1DTO)
        {
            DbCommand dbCommand = dbProvider.GetSqlStringCommand(Helper.SqlSaveT2SubestFicha1Det1);
        ...
        {
            DbCommand command = dbProvider.GetSqlStringCommand(Helper.SqlDeleteT2SubestFicha1Det1ById);
        ...
        {
            int count = 0;
            DbCommand command = dbProvider.GetSqlStringCommand(Helper.SqlGetLastT2SubestFicha1Det1Id);
        ...
        {
            List<T2SubestFicha1Det1DTO> dtos = new List<T2SubestFicha1Det1DTO>();
            DbCommand command = dbProvider.GetSqlStringCommand(Helper.SqlGetT2SubestFicha1Det1ById);
            dbProvider.AddInParameter(command, "PROYCODI", DbType.Int32, id);
            dbProvider.AddInParameter(command, "IND_DEL", DbType.String, Constantes.IndDel);
