...
{
    /// <summary>
    /// Clase de acceso a datos de la tabla CP_YUPCON_M48
    /// </summary>
    public class CpYupconM48Repository : RepositoryBase, ICpYupconM48Repository
    {
        public CpYupconM48Repository(string strConn) : base(strConn)
        {
        }

        CpYupconM48Helper helper = new CpYupconM48Helper();

        public int Save(CpYupconM48DTO entity)
        {
            ...
            dbProvider.AddInParameter(command, helper.Dyupcodi, DbType.Int32, id);
        ...
        public void Update(CpYupconM48DTO entity)
        {
            ...
            dbProvider.AddInParameter(command, helper.T47, DbType.Int32, entity.T47);
            dbProvider.AddInParameter(command, helper.T48, DbType.Int32, entity.T48);
            dbProvider.AddInParameter(command, helper.Dyupcodi, DbType.Int32, entity.Dyupcodi);
            dbProvider.AddInParameter(command, helper.Topcodi, DbType.Int32, entity.Topcodi);
            dbProvider.AddInParameter(command, helper.Recurcodi, DbType.Int32, entity.Recurcodi);
            dbProvider.AddInParameter(command, helper.Cyupcodi, DbType.Int32, entity.Cyupcodi);
            dbProvider.AddInParameter(command, helper.H1, DbType.Decimal, entity.H1);
        ...
        public void Delete(int dyupcodi)
        {
            DbCommand command = dbProvider.GetSqlStringCommand(helper.SqlDelete);

            dbProvider.AddInParameter(command, helper.Dyupcodi, DbType.Int32, dyupcodi);

            dbProvider.ExecuteNonQuery(command);
        }

        public CpYupconM48DTO GetById(int dyupcodi)
        {
            DbCommand command = dbProvider.GetSqlStringCommand(helper.SqlGetById);

            dbProvider.AddInParameter(command, helper.Dyupcodi, DbType.Int32, dyupcodi);
            CpYupconM48DTO entity = null;
        ...
        public List<CpYupconM48DTO> List()
        {
            List<CpYupconM48DTO> entitys = new List<CpYupconM48DTO>();
        ...
        public List<CpYupconM48DTO> GetByCriteria(int cyupcodi)
        {
            List<CpYupconM48DTO> entitys = new List<CpYupconM48DTO>();
            string sql = string.Format(helper.SqlGetByCriteria, cyupcodi);
