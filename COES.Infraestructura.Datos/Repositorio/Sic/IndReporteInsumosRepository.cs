...
{
    /// <summary>
    /// Clase de acceso a datos de la tabla IND_REPORTE_INSUMOS
    /// </summary>
    public class IndReporteInsumosRepository : RepositoryBase, IIndReporteInsumosRepository
    {
        public IndReporteInsumosRepository(string strConn) : base(strConn)
        {
        }

        IndReporteInsumosHelper helper = new IndReporteInsumosHelper();
        ...
        public void Save(IndReporteInsumosDTO entity, IDbConnection conn, DbTransaction tran)
        {
            ...
            command.Parameters.Add(dbProvider.CreateParameter(command, helper.Irpinscodi, DbType.Int32, entity.Irpinscodi));
            command.Parameters.Add(dbProvider.CreateParameter(command, helper.Itotcodi, DbType.Int32, entity.Itotcodi));
            command.Parameters.Add(dbProvider.CreateParameter(command, helper.Irpinstipo, DbType.Int32, entity.Irpinstipo));
            ...
            command.Parameters.Add(dbProvider.CreateParameter(command, helper.Irpinsusucreacion, DbType.String, entity.Irpinsusucreacion));
            command.Parameters.Add(dbProvider.CreateParameter(command, helper.Irpinsfeccreacion, DbType.DateTime, entity.Irpinsfeccreacion));
            command.ExecuteNonQuery();
        }

        public void Delete(int irpinscodi)
        {
            DbCommand command = dbProvider.GetSqlStringCommand(helper.SqlDelete);

            dbProvider.AddInParameter(command, helper.Irpinscodi, DbType.Int32, irpinscodi);

            dbProvider.ExecuteNonQuery(command);
        }

        public IndReporteInsumosDTO GetById(int irpinscodi)
        {
            DbCommand command = dbProvider.GetSqlStringCommand(helper.SqlGetById);

            dbProvider.AddInParameter(command, helper.Irpinscodi, DbType.Int32, irpinscodi);
            IndReporteInsumosDTO entity = null;
        ...
        public List<IndReporteInsumosDTO> GetByCriteria(string itotcodi)
        {
            List<IndReporteInsumosDTO> entitys = new List<IndReporteInsumosDTO>();
            ...
            using (IDataReader dr = dbProvider.ExecuteReader(command))
            {
                while (dr.Read())
                {
                    IndReporteInsumosDTO entity = helper.Create(dr);
        ...
        public List<IndReporteInsumosDTO> List()
        {
            List<IndReporteInsumosDTO> entitys = new List<IndReporteInsumosDTO>();
