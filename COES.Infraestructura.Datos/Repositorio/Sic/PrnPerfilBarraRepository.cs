...
{
    public class PrnPerfilBarraRepository : RepositoryBase, IPrnPerfilBarraRepository
    {
        public PrnPerfilBarraRepository(string strConn) : base(strConn)
        {
        }

        PrnPerfilBarraHelper helper = new PrnPerfilBarraHelper();

        public void Save(PrnPerfilBarraDTO entity)
        {
            ...
            dbProvider.AddInParameter(command, helper.Prfbarcodi, DbType.Int32, id);
            dbProvider.AddInParameter(command, helper.Reltnacodi, DbType.Int32, entity.Reltnacodi);
            dbProvider.AddInParameter(command, helper.Prfbartipodia, DbType.String, entity.Prfbartipodia);
        ...
        public void Update(PrnPerfilBarraDTO entity)
        {
        ...
        public void Delete(int prfbarcodi)
        {
            DbCommand command = dbProvider.GetSqlStringCommand(helper.SqlDelete);
            dbProvider.AddInParameter(command, helper.Prfbarcodi, DbType.Int32, prfbarcodi);            
            dbProvider.ExecuteNonQuery(command);
        }

        public List<PrnPerfilBarraDTO> List()
        {
            List<PrnPerfilBarraDTO> entitys = new List<PrnPerfilBarraDTO>();
        ...
        public PrnPerfilBarraDTO GetByIds(int reltnacodi, string prfbartipodia)
        {
            PrnPerfilBarraDTO entity = new PrnPerfilBarraDTO();
            string query = string.Format(helper.SqlGetByIds,
                reltnacodi, prfbartipodia);
