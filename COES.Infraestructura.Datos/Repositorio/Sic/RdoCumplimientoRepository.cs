...
{
    public class RdoCumplimientoRepository : RepositoryBase, IRdoCumplimientoRepository
    {
        string sConn = string.Empty;
        public RdoCumplimientoRepository(string strConn) : base(strConn)
        {
            sConn = strConn;
        }

        
        RdoCumplimientoHelper helper = new RdoCumplimientoHelper();
        ...
        public List<RdoCumplimiento> GetByCriteria(RdoCumplimiento estudioeo)
        {
            ...
            using (IDataReader dr = dbProvider.ExecuteReader(command))
            {
                while (dr.Read())
                {
                    ...
                    int iEstepocodiusu = dr.GetOrdinal(helper.RdoNombreEmpresa);
