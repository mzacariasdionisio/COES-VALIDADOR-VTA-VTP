...
$(function () {
    ...
    $('#btnGrabarFichaCCTTB').on('click', function () {
        grabarFichaCCTTB();
    });

    var formulariob = document.getElementById('TFichaB');
...
// Asociar la función calcularInversionTotal al evento input de los campos relevantes
...
// Llamar a la función al cargar la página para inicializar los valores si es necesario
...
getDataHojaCCTTB = function () {
    var param = {};

    // Obtener los valores de los campos de inversión
    ...
    // Obtener los valores calculados de inversión total
...
function cargarDatosB() {
    ...
    if (modoModel == "editar" || modoModel == "consultar") {
        ...
        $.ajax({
            type: 'POST',
            url: controladorFichas + 'GetRegHojaCCTTB',
            ...
            success: function (response) {
                ...
                if (hojaAData.Proycodi == 0) {
                    //hojaAData.Concesiondefinitiva = obtenerFechaActualMesAnio();
                    //hojaAData.Contratosfinancieros = obtenerFechaActualMesAnio();
                    //hojaAData.Ejecucionobra = obtenerFechaActualMesAnio();
                    //hojaAData.Contratosfinancieros = obtenerFechaActualMesAnio();
                } 
...
setHojaB = function (param) {
    ...
    if (modoModel == "consultar") {
        desactivarCamposFormulario('TFichaB');
        $('#btnGrabarFichaCCTTB').hide();
    }
}