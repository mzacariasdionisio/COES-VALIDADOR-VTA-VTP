...
using COES.MVC.Extranet.Areas.DemandaBarras.Helper;
...
namespace COES.MVC.Extranet.Areas.DemandaBarras.Controllers
{
    public class EnvioController : BaseController
    {
        ...
        public JsonResult LeerFileUpExcel(int idEmpresa, string mes)
        {
            ...
            if (retorno > 0)
            {
                ...
                var listaPtos = this.logic.GetByCriteria2MeHojaptomeds(idEmpresa, this.IdFormato, cabercera.Cabquery, formato.FechaInicio, formato.FechaFin);
        ...
        public FormatoModel BuildHojaExcel(int idEmpresa, int idEnvio, string mes)
        {
            ...
            model.ListaHojaPto = logic.GetListaPtos(model.Formato.FechaFin, idCfgFormato, idEmpresa, this.IdFormato, cabercera.Cabquery);
