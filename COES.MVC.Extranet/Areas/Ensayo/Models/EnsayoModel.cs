...
namespace COES.MVC.Extranet.Areas.Ensayo.Models
{
    public class EnsayoModel
    {
        public string Resultado { get; set; }//para saber si guardo el ensayo
        ...
        public List<int> ListaDeUnidades { get; set; }
        ...
        public List<EnEnsayomodoDTO> LstEnsayoModo { get; set; }
        public List<EnEnsayomodequiDTO> LstEnsayoModEqui { get; set; }
        public List<PrGrupoDTO> ListaEspecial { get; set; }  //Lista con MO especiales

        public int Opt01 { get; set; }
        public int Opt02 { get; set; }
        public List<int> listitaUnidades { get; set; }  //Lista con valores equicodi de las unidade especiales
        ...
        public string ListaFormatoJson { get; set; }
        public string ListaEquipoJson { get; set; }
    }
    ...
    public class ModoOperacionConSusUnidadesModel
    {
        public int CodigoMO { get; set; }
