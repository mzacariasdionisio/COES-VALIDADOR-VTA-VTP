...
using COES.MVC.Extranet.Areas.GMM.Models;
...
using COES.MVC.Extranet.Areas.GMM.Helper;
using COES.MVC.Extranet.Helper;

namespace COES.MVC.Extranet.Areas.GMM.Controllers
{
    public class GarantiasController : BaseController
    {
        ...
        protected override void OnException(ExceptionContext filterContext)
        {
            ...
            try
            {
                ...
                Log.Error("GarantiasController", objErr);
            }
            catch (Exception ex)
            {
                Log.Fatal("GarantiasController", ex);
                throw;
            }
        }

        // GET: /GMM/Garantias/Index
                        ...
                        using (ExcelPackage xlPackage = new ExcelPackage(newFile))
                        {
                            ...
                            if (ws != null)
                            {
                                ...
                                foreach (var item in datosRptInsumo)
                                {
                                    ...
                                    ws.Cells[row, 6].Value = item.insumo.ToString().Trim();
                                    ws.Cells[row, 7].Value = item.valor;
                            ...
                            {   //TITULO
                                ...
                                if(datosRPT4.Count()==0)
                                {
                                    ...
                                    */
                                    ...
                                    //ws.Column(6).Width = 21.5;
                                    //ws.Column(6).Style.WrapText = true;

                                    row++;
                                    //ws.Cells[row, 2].Value = mesCadenaAct + " - " + anio;
                                    //ws.Cells[row, 3].Value = item.EMPRESA.ToString().Trim();
                                    //ws.Cells[row, 4].Value = item.RMES1.ToString().Trim();
                                    //ws.Cells[row, 5].Value = item.RMES2.ToString().Trim();
                                    //ws.Cells[row, 6].Value = item.RMES3.ToString().Trim();
                                    //ws.Cells[row, 7].Value = item.RSCOMPLE.ToString().Trim();
                    ...
                    case "rpt6":
                        ...
                        using (ExcelPackage xlPackage = new ExcelPackage(newFile))
                        {
                            ...
                            {   //TITULO
                                ...
                                //CABECERA DE TABLA
                                ws.Cells[row++, 3].Value = "Primer cálculo de nuevos participantes";
                                ...
                                if(datosRPT6.Count()==0)
                                {
                                    ...
                                    //ws.Cells[row, 4].Value = item.RLSCIO.ToString().Trim();
                                    //ws.Cells[row, 5].Value = item.RCOL1.ToString().Trim();
                                    //ws.Cells[row, 6].Value = item.RCOL2.ToString().Trim();
                                    //ws.Cells[row, 7].Value = item.RINFLEXOP.ToString().Trim();
                                    ...
                                    ws.Cells[row - 1, 2].Style.WrapText = true;
                                    ws.Cells[row - 1, 3].Value = "Epm";
                                    //ws.Cells[row - 1, 4].Value = item.RER10.ToString().Trim();
                                    ws.Cells[row++, 2].Value = "Energía Prevista a Retirar " + mesCadenaSig + "-" + anioMesSig;
                                    ws.Cells[row - 1, 2].Style.WrapText = true;
                                    ws.Cells[row - 1, 3].Value = "Epm+1";
                                    //ws.Cells[row - 1, 4].Value = item.REPR11.ToString().Trim();
                        ...
                        using (ExcelPackage xlPackage = new ExcelPackage(newFile))
                        {
                            ...
                            {   //TITULO
                                ...
                                if(datosRPT5.Count()==0)
                                {
                                    ...
                                    row = row + 2;
                                    ws.Cells[row++, 3].Value = "Energia Retirada 10 dias + Energia Prevista (10-m) " + mesCadenaAct + "-" + anio;
                                    ws.Cells[row - 1, 3].Style.WrapText = true;
                                    ws.Cells[row - 1, 4].Value = "Epm";
                                    //ws.Cells[row - 1, 5].Value = item.RER10.ToString().Trim();
                                    ws.Cells[row++, 3].Value = "Energía Prevista a Retirar " + mesCadenaSig + "-" + anioMesSig;
                                    ws.Cells[row - 1, 3].Style.WrapText = true;
                                    ws.Cells[row - 1, 4].Value = "Epm+1";
                                    //ws.Cells[row - 1, 5].Value = item.REPR11.ToString().Trim();

                                    //ws.Column(3).Width = 25.5;
                                    //ws.Column(3).Style.WrapText = true;

                                    rg = ws.Cells[row - 2, 3, row - 1, 4];
                                    rg.Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                                    rg.Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                                    rg.Style.Fill.PatternType = ExcelFillStyle.Solid;
                                    rg.Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml("#2980B9"));
                                ...
                                ws.Column(4).Width = 26.57;
                                ws.Column(5).Width = 28.86;
                                ws.Column(6).Width = 24.29;
                                ws.Column(7).Width = 24.29;
                                ws.Column(8).Width = 16.43;
                                ws.Column(9).Width = 16.43;
                                ws.Column(10).Width = 16.43;
