...
{
    public class PotAutoProdController : FormatoController
    {
        #region Declaración de variables

        private static readonly ILog Log = log4net.LogManager.GetLogger(typeof(PotAutoProdController));
        ...
        #region METODOS POTENCIA AUTOPRODUCCION

        /// <summary>
        /// Index de portencia autoproducción
        /// </summary>
        /// <returns></returns>
        public ActionResult Index()
        {
            ...
            base.IndexFormato(model, ConstantesHard.IdFormatoPotenciaAutoProd);
        ...
        /// <summary>
        /// Metodo llamado desde cliente web para consultar el formato excel web de potencia autoproducción
        /// </summary>
        ...
        {
            List<MeHojaptomedDTO> entitys = servFormato.ObtenerPtosXFormato(ConstantesHard.IdFormatoPotenciaAutoProd, idEmpresa);
            if (entitys.Count > 0)
            {
                FormatoModel jsModel = BuildHojaExcelPotenciaAutoProd(idEmpresa, idEnvio, fecha, verUltimoEnvio);
                return Json(jsModel);
            }
            else
            {
        ...
        /// <summary>
        /// Devuelve el model con informacion de portencia autoprodcción
        /// </summary>sic
        /// <param name="idEmpresa"></param>
        /// <param name="idEnvio"></param>
        /// <param name="fecha"></param>
        /// <returns></returns>
        public FormatoModel BuildHojaExcelPotenciaAutoProd(int idEmpresa, int idEnvio, string fecha, int verUltimoEnvio)
        {
            FormatoModel model = new FormatoModel();
            BuildHojaExcel(model, idEmpresa, idEnvio, fecha, ConstantesHard.IdFormatoPotenciaAutoProd, verUltimoEnvio);

            return model;
        }

        /// <summary>
        /// Graba los datos enviados por el agente del formato potencia autoproduccion
        /// </summary>
        ...
        /// <summary>
        /// Permite generar el formato en formato excel de potencia autoproducción
        /// </summary>
        /// <returns></returns>
        [HttpPost]
        public string GenerarFormato(string[][] data, int idEmpresa, string dia, int idEnvio)
        {
            ...
            try
            {
                ...
                FormatoModel model = BuildHojaExcelPotenciaAutoProd(idEmpresa, idEnvio, dia, ConstantesFormato.NoVerUltimoEnvio);
