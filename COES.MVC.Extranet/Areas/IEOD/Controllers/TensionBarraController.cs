...
{
    public class TensionBarraController : FormatoController
    {
        #region Declaración de variables

        private static readonly ILog Log = log4net.LogManager.GetLogger(typeof(TensionBarraController));
        ...
        #region METODOS TENSION DE BARRAS

        /// <summary>
        /// Index de Tension de barras
        /// </summary>
        /// <returns></returns>
        public ActionResult Index()
        {
            ...
            base.IndexFormato(model, ConstantesHard.IdFormatoTensionBarra);
            return View(model);
        }
        ...
        /// <summary>
        /// Metodo llamado desde cliente web para consultar el formato excel web de Tensión de barras
        /// </summary>
        ...
        {
            List<MeHojaptomedDTO> entitys = servFormato.ObtenerPtosXFormato(ConstantesHard.IdFormatoTensionBarra, idEmpresa);
            if (entitys.Count > 0)
            {
                FormatoModel jsModel = BuildHojaExcelTensionBarra(idEmpresa, idEnvio, fecha, verUltimoEnvio);
                return Json(jsModel);
            }
            else
            {
        ...
        /// <summary>
        /// Devuelve el model con informacion de tension de barras
        /// </summary>sic
        /// <param name="idEmpresa"></param>
        /// <param name="idEnvio"></param>
        /// <param name="fecha"></param>
        /// <returns></returns>
        public FormatoModel BuildHojaExcelTensionBarra(int idEmpresa, int idEnvio, string fecha, int verUltimoEnvio)
        {
            FormatoModel model = new FormatoModel();
            model.ValidaMantenimiento = true;
            model.UtilizaScada = true;
            BuildHojaExcel(model, idEmpresa, idEnvio, fecha, ConstantesHard.IdFormatoTensionBarra, verUltimoEnvio);
        ...
        /// <summary>
        /// Graba los datos enviados por el agente del formato tension de barras
        /// </summary>
        ...
        /// <summary>
        /// Permite generar el formato en formato excel de Tensión de barras
        /// </summary>
        /// <returns></returns>
        [HttpPost]
        public string GenerarFormato(string[][] data, int idEmpresa, string dia, int idEnvio)
        {
            ...
            try
            {
                ...
                FormatoModel model = BuildHojaExcelTensionBarra(idEmpresa, idEnvio, dia, ConstantesFormato.NoVerUltimoEnvio);
