        ...
        { 
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(newFile, template))
            {
                ...
                foreach (var reg in lista)
                {
                    ...
                    if (reg.Estenvcodi == ConstantesInterconexiones.EnPlazo)
                        cumplimiento = ConstantesInterconexiones.CumplimientoEnPlazo;
                    if (reg.Estenvcodi == ConstantesInterconexiones.FueraPlazo)
                        cumplimiento = ConstantesInterconexiones.CumplimientoFueraDePlazo;
