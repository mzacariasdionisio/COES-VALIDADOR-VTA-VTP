...
$(document).ready(function ($) {
    ...
    $('#btnContraer').click(
        function (e) {
            ...
            $("#listado").hide();
            var nuevoTamanioTabla = ocultar == 1 ? obtenerMedida() : getHeightTablaListado();
    ...
    <table border="0" class="pretty tabla-icono" id="TablaConsultaIntervencion" style=" overflow: auto; height:auto; width: 2000px !important; white-space: nowrap">
        <thead>
            <tr>
                ...
                <th style="text-align:center">Mensajes <br>enviados</th>
    ...
    for (key in lista) {
        ...
        cadena += `
            ...
            <tr id="fila_${item.Intercodi}">
                ...
                <td style="${sStyle}">
                    <input type="checkbox" class="ChkSeleccion1" disabled="disabled" ${checked} />
                </td>
...
function mostrarPopupNotificacion(model) {
    ...
    var cadena = '';
    cadena += `
    <table border="0" class="pretty tabla-icono" id="TablaConsultaIntervencionNoLeido" style="overflow: auto; height:auto; width: 1000px !important; white-space: nowrap">
        <thead>
            <tr>
