...
namespace COES.MVC.Extranet.Areas.Medidores.Controllers
{
    public class AmpliacionController : BaseController
    {
        ...
        public PartialViewResult Lista(int empresa, string fecha)
        {
            ...
            var lista = this.logic.ObtenerListaMeAmpliacionfechas(fechaIni, fechaFin, empresa, 2);
        ...
        public JsonResult GrabarValidacion(string fecha, int hora, int empresa)
        {
            ...
            ampliacion.Formatcodi = ConstantesMedidores.IdFormato;
            ...
            try
            {
                var reg = logic.GetByIdMeAmpliacionfecha(fechaEnvio, empresa, ConstantesMedidores.IdFormato);
                if (reg == null)
                {
