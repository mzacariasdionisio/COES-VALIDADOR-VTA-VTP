...
namespace COES.MVC.Extranet.Areas.Medidores.Models
{
    public class MedidorGeneracionModel : FormatoModel
    {
        ...
        public string TituloCargaCentralPotReactiva { get; set; }
        public string TituloCargaServAuxPotReactiva { get; set; }

        public int IdFormatoCargaCentralPotActiva { get; set; }
        public int IdFormatoCargaCentralPotReactiva { get; set; }
        public int IdFormatoCargaServAuxPotReactiva { get; set; }
