   ...
   */
   $(document).ready(function () {
       ...
       $('input[type=radio][name=tipoEmpresa]').change(function () {
           ...
           document.getElementById('cbEmpresa').value = '0';
...
function guardarCargaEsencial() {
    ...
    var empresaseleccionada = document.getElementById("cbEmpresa").value;    

    if (empresaseleccionada == "" || empresaseleccionada == null || empresaseleccionada == "0") {
