...
namespace COES.MVC.Extranet.Areas.Resarcimientos.Models
{
    ...
    public class RntPeriodoModel
    {
        public List<RntPeriodoDTO> ListaRntPeriodo { get; set; }
    ...
    // Se agrego PUNTO DE ENTREGA Y RECHAZO DE CARGA
    ...
    public class PEntregaModel
    {
        ...
        public EqAreaDTO ListaComboSeleccionar
        {
            get
            {
                EqAreaDTO a = new EqAreaDTO();
                a.Areacodi = 0;
                a.Areanomb = "-----(Seleccione)-----";
                return a;
            }
        }
    }
    ...
    public class RegistroRechazoCargaModel
    {
        ...
        public System.String RRCCOMPENSABLE { get; set; }
