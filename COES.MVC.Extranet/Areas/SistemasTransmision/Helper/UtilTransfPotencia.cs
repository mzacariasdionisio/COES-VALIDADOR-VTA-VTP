...
namespace COES.MVC.Extranet.Areas.SistemasTransmision.Helper
{
    public class UtilTransfPotencia
    {
        ...
        public static List<SeguridadServicio.EmpresaDTO> ObtenerEmpresasPorUsuario(string usuario)
        {
            ...
            if (usuario == "azucena.cabrera" || usuario == "raul.castro" || usuario == "lvasquez" || usuario == "ppajan"
                || usuario == "eenriquez" || usuario == "tseminario" || usuario == "gloria.colmenares")
            {
