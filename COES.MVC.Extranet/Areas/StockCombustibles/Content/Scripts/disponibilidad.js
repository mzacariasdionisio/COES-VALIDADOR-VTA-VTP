...
$(function () {
    ...
    $('#btnEditarEnvio').click(function () {
        ...
        mostrarFormularioDisponibilidad();
    });
    ...
    $.ajax({
        ...
        success: function (evt) {
            if (evt != -1) {
                ...
                document.location.href = controlador + 'disponibilidadgas';
            }
            ...
            $.ajax({
                ...
                success: function (evt) {
                    if (evt.Resultado == 1) {
                        ...
                        $("#btnMostrarErrores").parent().hide();
                        $("#btnAgregarFila").parent().parent().hide();
                        mostrarFormularioDisponibilidad(envioDatos);
...
function mostrarEnvioExcelWeb(envio) {
    ...
    $("#hfIdEnvio").val(envio);
    mostrarFormularioDisponibilidad(envioAnterior);
}
...
function agregarFilaHandson() {
    ...
    grillaBD.push([evtHot.ListaPtoMedicion[0].id, getHoraInicio(), "0", listaEstado[0].id, "", "", idEmpresa]);
