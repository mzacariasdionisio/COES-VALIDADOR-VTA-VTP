...
function mostrarMsgEnPlazo() {
    $('#mensajePlazo').html("Por favor complete los datos. <strong>Plazo del Envio: </strong> <strong style='color:green'>En plazo</strong>");
...
function mostrarMsgErrorValores() {
    $('#mensajePlazo').html("No está permitido el valor ingresado por favor verifique el detalle en Ver Errores");
    $('#mensajePlazo').addClass("action-alert");
    $('#mensajePlazo').css("display", "block");
}

function mostrarAletarErrorValores(alerta) {
    $('#mensajeEvento').removeClass("action-message");
    $('#mensajeEvento').removeClass("action-exito");
    $('#mensajeEvento').addClass("action-alert");
    $('#mensajeEvento').html(alerta);
