...
namespace COES.MVC.Extranet.Controllers
{
    ...
    {
        /// <summary>
        /// la validación de la sesión del usuario ya no se hace en el "fileapp" sino en intranet
        /// </summary>
        ...
        public virtual ActionResult DescargarSustentoConfidencial(string url, string idapp)
        {
            ...
            {
                //solo permitir la descarga del archivo cuando se realiza un nuevo envio temporal. No cuando el agente usa la URL desde su navegador
                bool esAgenteConPermiso = ConstantesFichaTecnica.ClaveOcultaPermiteDescargaConfidencial == idapp;

                if (esAgenteConPermiso)
                {
