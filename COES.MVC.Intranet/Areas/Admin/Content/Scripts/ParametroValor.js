var controlador = siteRoot + 'admin/parametrovalor/';
...
validarRegistro = function () {
    ...
    if ($('#cbSiparCodi').val() != $('#hfIdParametroAGC').val()) {
        $('#hfSiparvValor').val($('#txtSiparvValor').val());
        ...
        $('#hfSiparvValor').val($('#txtSiparvValor').val().replace(':', ''));

        if ($('#txtSiparvValor').val() != "") {
            if (!validarHoraMinuto($('#txtSiparvValor').val())) {
                mensaje = mensaje + "<li>Debe ingresar formato hh:mm</li>";
                flag = false;
            }
        }
        else {
            mensaje = mensaje + "<li>Por favor ingrese el valor del parámetro.</li>";
            flag = false;
        }
    }
...
validarHoraMinuto = function (hora) {
