...
namespace COES.MVC.Intranet.Areas.Admin.Controllers
{
    public class ParametroValorController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            model.ListaSiParametro = servicio.ListSiParametros();
        ...
        public ActionResult Editar(int id, int accion)
        {
            ...
            if (id != 0)
                siParametroValor = servicio.GetByIdSiParametroValor(id);
            ...
            model.IdParametroAGC = COES.Servicios.Aplicacion.ServicioRPF.Helper.ConstantesDatosAGC.IdParametroPlazo;
            model.Accion = accion;
            return View(model);
        ...
        public JsonResult Eliminar(int id)
        {
            try
            {
                servicio.DeleteSiParametroValor(id);
                return Json(1);
            }
            catch
            {
        ...
        public JsonResult Grabar(SiParametroValorModel model)
        {
            try
            {
                ...
                int id = this.servicio.SaveSiParametroValorId(entity);
                return Json(id);
            }
            catch
            {
        ...
        public PartialViewResult Lista(int siparCodi, string siparvFechaInicial, string siparvFechaFinal, int nroPage, string estado)
        {
            ...
            model.ListaSiParametroValor = servicio.BuscarOperaciones(siparCodi, fechaInicio, fechaFinal, nroPage, Constantes.PageSizeEvento, estado).ToList();
            model.AccionNuevo = base.VerificarAccesoAccion(Acciones.Nuevo, base.UserName);
            model.AccionEditar = base.VerificarAccesoAccion(Acciones.Editar, base.UserName);
            model.AccionEliminar = base.VerificarAccesoAccion(Acciones.Eliminar, base.UserName);
            model.IdParametroAGC = COES.Servicios.Aplicacion.ServicioRPF.Helper.ConstantesDatosAGC.IdParametroPlazo;
        ...
        public PartialViewResult Paginado(int siparCodi, string siparvFechaInicial, string siparvFechaFinal, string estado)
        {
            ...
            int nroRegistros = servicio.ObtenerNroFilas(siparCodi, fechaInicio, fechaFinal, estado);
