...
namespace COES.MVC.Intranet.Areas.AporteIntegrates.Helper
{
    public class FormatoDemandaHelper
    {
        ...
        public static void GenerarFileExcel(FormatoModel model)
        {
            ...
            string fileTemplate = "PlantillaProgDiario.xlsx"; 
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(newFile, template))
            {
                ...
                row = 16; //ConstantesDemanda.FilaExcelData;
        ...
        {
            int ConstantesDemanda_FilaExcelData = 16;
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(fileInfo))
            {
                ...
                for (int i = 0; i < nFil; i++)
                {
                    ...
                    {
                        string valor = (ws.Cells[i + rowsHead + ConstantesDemanda_FilaExcelData, j + colsHead + 1].Value != null) ?
                            ws.Cells[i + rowsHead + ConstantesDemanda_FilaExcelData, j + colsHead + 1].Value.ToString() : string.Empty;
        ...
        {
            int Ejecutado = 1; //ParametrosLecturaHidro.Ejecutado
            switch (formato.Formatperiodo)
            {
                case ParametrosFormato.PeriodoDiario:
                    ...
                    {
                        if (formato.Lecttipo == Ejecutado) //Ejecutado
                        {
                        ...
                        else
                        {
                            ...
                            formato.FechaPlazoIni = formato.FechaProceso;
                            formato.FechaPlazo = formato.FechaProceso.AddMinutes(formato.Formatminplazo);
                        }
                    }
                    break;
                case ParametrosFormato.PeriodoSemanal:
        ...
        /// <param name="enPlazo"></param>
        /// <returns></returns>
        public static string GenerarFormatoHtml2(FormatoModel model, int idEnvio, Boolean enPlazo)
        {
            StringBuilder strHtml = new StringBuilder();
        ...
        /// <param name="nCol"></param>
        /// <returns></returns>
        public static string[][] InicializaMatrizExcel_2(int rowsHead, int nFil, int colsHead, int nCol)
        {
            string[][] matriz = new string[nFil + rowsHead][];
            for (int i = 0; i < nFil; i++)
            {
        ...
        /// <param name="listaCambios"></param>
        /// <param name="formato"></param>
        public static void ObtieneMatrizWebExcel_2(FormatoModel model, List<object> lista, List<MeCambioenvioDTO> listaCambios, int idEnvio)
        {
            //if (idEnvio > 0)
            //{
            foreach (var reg in listaCambios)
        ...
        {
            string NombreArchivoLogo = "coes.png"; //ConstantesHidrologia.NombreArchivoLogo
            string rutaLogo = ruta + NombreArchivoLogo;
            FileInfo newFile = new FileInfo(ruta + model.Formato.Formatnombre + ".xlsx");
            if (newFile.Exists)
            {
                newFile.Delete();
        ...
        /// <returns></returns>
        public static int VerificarIdsFormato2(string file, int idEmpresa, int idFormato)
        {
            int retorno = 1;
            int idEmpresaArchivo;
            int idFormatoEmpresa;
        ...
        /// </summary>
        /// <param name="formato"></param>
        public static void GetSizeFormato3(MeFormatoDTO formato)
        {
            int Ejecutado = 1;  //ParametrosLecturaHidro.Ejecutado
            switch (formato.Formatperiodo)
            {
        ...
        /// <param name="nCol"></param>
        /// <returns></returns>
        public static string[][] InicializaMatrizExcel2(int rowsHead, int nFil, int colsHead, int nCol)
        {
            string[][] matriz = new string[nFil + rowsHead][];
            for (int i = 0; i < nFil; i++)
            {
        ...
        /// <param name="nCol"></param>
        /// <returns></returns>
        public static Boolean LeerExcelFile_1(string[][] matriz, string file, int rowsHead, int nFil, int colsHead, int nCol)
        {
            Boolean retorno = false;
            FileInfo fileInfo = new FileInfo(file);
            using (ExcelPackage xlPackage = new ExcelPackage(fileInfo))
        ...
        public static void BorrarArchivo2(String archivo)
        {
            if (System.IO.File.Exists(@archivo))
            {
                try
        ...
        /// </summary>
        /// <param name="formato"></param>
        public static void GetSizeFormato4(MeFormatoDTO formato)
        {
            int Ejecutado = 1; //ParametrosLecturaHidro.Ejecutado
            switch (formato.Formatperiodo)
            {
