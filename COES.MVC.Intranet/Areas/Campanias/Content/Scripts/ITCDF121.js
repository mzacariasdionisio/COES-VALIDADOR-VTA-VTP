...
function crearTablaITCF121(anioInicia, anioFin, data) {
    ...
    for (var i = anioInicia; i <= anioFin; i++) {
        ...
        listaTypeNumeric121.push({ type: "numeric", renderer: currencyRenderer121 , readOnly: true});
    }
    ...
    hot121 = new Handsontable(grilla, {
        ...
        columns: [
            { type: "text" , readOnly: true}, // Columna 0
            { type: "text" , readOnly: true}, // Columna 1
            { type: "text" , readOnly: true}, // Columna 2
            { type: "numeric" , readOnly: true}, // Columna 3
            { type: "text" , readOnly: true}, // Columna 4
            { type: "text", readOnly: true}, // Columna 5
