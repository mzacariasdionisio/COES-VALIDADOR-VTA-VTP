    ...
    public class FichasProyectoController : BaseController
    {
        ...
        public ActionResult UploadArchivoGeneral(int? id, string ordena_ruta = "")
        {
            try
            {
                ...
                {
                    var file = Request.Files[0];
                    //  string path = campaniasAppService.ObtenerPathArchivosCampianas()+ARCHUBICACION;
        ...
        public JsonResult GetCuestionarioH2A(int id)
        {
            ...
            List<CuestionarioH2VADet1DTO> Lista1DTO = campaniasAppService
                                          .GetCuestionarioH2VADet1ById(regHojaa.H2vaCodi)
                                          .OrderBy(x => x.Anio)
                                          .ToList();
        ...
        public PartialViewResult Observaciones()
        {
            CampaniasModel model = new CampaniasModel();
            try
            {
