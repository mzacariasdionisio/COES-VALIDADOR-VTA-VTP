...
function exportar() {
      ...
      $.ajax({
        type: 'POST',
        url: controlador + 'exportarCompensacionesRegulares',
        data: {
            pecacodi: $("#pecacodi").val(),
            empresa: $("#empresa").val(),
            central: $("#central").val(),
...
var pintarBusqueda =
    ...
    */
    function () {
        ...
        $.ajax({
            type: "POST",
            url: controlador + "listarCompensacionesRegulares",
            data: {
                pecacodi: $("#pecacodi").val(),
                empresa: $("#empresa").val(),
                central: $("#central").val(),
...
function ObtenerListaCentral(valor, selected) {
    ...
    if (valor != "") {
        $.ajax({
            ...
            error: function () {
                mostraError('Ha ocurrido un error', $tipoMensajeError, $modoMensajeCuadro);
            }
        });
    }
    else {
