...
editarRelacion = function (id) {
    ...
    $.ajax({
        ...
        success: function (evt) {
            ...
            $('#cbCanalUso').val($('#hfCanalUso').val());
            $('#cbCanalSigno').val($('#hfCanalSigno').val());
            ...
            if ($('#hfIndFuente').val() == "G") {

                $('#cbEmpresaEdit').prop('readonly', true);
                $('#cbEquipoEdit').prop('readonly', true);
                $('#txtNomBarra').prop('readonly', true);
                $('#txtIdGenerador').prop('readonly', true);

                $('#cbEmpresaEdit').css("backgroundColor", "#f8f8f8");
                $('#cbEquipoEdit').css("backgroundColor", "#f8f8f8");
                $('#txtNomBarra').css("backgroundColor", "#f8f8f8");
                $('#txtIdGenerador').css("backgroundColor", "#f8f8f8");                
            }
        },
        error: function () {
