//var controlador = siteRoot + 'demandacp/envio/';
var uploader;
var totNoNumero = 0;
var totLimSup = 0;
var totLimInf = 0;
...
function cargarExcelWebPronostico() {
    if (typeof hot != 'undefined') {
        hot.destroy();
    }
    $('#hfEmpresa').val($('#cbEmpresa').val());
...
function crearPupload() {
    uploader = new plupload.Uploader({
        ...
        url: siteRoot + 'demandacp/envio/Upload',
...
function horizonte () {
    const opcion = parseInt($('#cbHorizonte').val()) || 0;
