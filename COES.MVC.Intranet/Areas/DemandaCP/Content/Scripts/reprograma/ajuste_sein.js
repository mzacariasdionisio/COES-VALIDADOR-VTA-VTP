...
function obtenerDatos() {
    ...
    $.ajax({
        type: 'POST',
        url: `${controlador}ObtenerDatosAjusteSein`,
        contentType: 'application/json; charset=utf-8',
        data: JSON.stringify({
            selVersion: (_version) ? _version : -1,
            selYupana: (_yupana) ? _yupana : -1,
            selFecha: _fecha,
        ...
        success: function (result) {
            ...
            //Crea el highchart
            var hc_title = "Demanda a nivel de generación";
...
function registrarDatos(_datos) {
    ...
    $.ajax({
        type: 'POST',
        url: `${controlador}RegistrarDatosAjusteSein`,
        contentType: 'application/json; charset=utf-8',
        data: JSON.stringify({
...
function obtenerEscenarios() {
    const _fecha = $('#repSelFechaComp').val();
    $.ajax({
        type: 'POST',
        url: `${controlador}ObtenerEscenarioAjusteSein`,
        contentType: 'application/json; charset=utf-8',
        data: JSON.stringify({            
            selFecha: _fecha,
        }),
        ...
        traditional: true,
        success: function (res) {
            RefillDropDowList($('#selEscenario'),
                res, 'Topcodi', 'Topnombre');
