...
$(function () {
    ...
    $('#idUbicacion').multipleSelect('setSelects', ['0']);
    $('#idTitular').multipleSelect('setSelects', ['0']);
...
let consultar = function () {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            type: 'POST',
            url: controlador + 'BuscarCeldaAcoplamientoLista?equiCodi=' + equiCodi + "&codigo=" + codigo + "&ubicacion=" + ubicacion + "&empresa=" + emprCodigo + "&estado=" + equiEstado,
...
function incluir(e) {
    ...
    if (idEquipo == '') {
        alert("Seleccione una celda de acoplamiento a incluir");
        return;
    }
    ...
    $.ajax({
        ...
        success: function (evt) {
            ...
            $("#btnSeleccionar").click(function () {
                ...
                window.location.href = controlador + "IncluirModificar?IdCeldaAcoplamiento=0&idProyecto=" + idProyecto + "&idEquipo=" + id + "&accion=Incluir";
            });
