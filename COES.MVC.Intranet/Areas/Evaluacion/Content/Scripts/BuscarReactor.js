...
let consultar = function () {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            type: 'POST',
            url: controlador + 'BuscarReactorLista?equiCodi=' + equiCodi + "&codigo=" + codigo + "&ubicacion=" + ubicacion + "&empresa=" + emprCodigo + "&estado=" + equiEstado,
...
function incluir(e) {
    ...
    if (idEquipo == '') {
        alert("Seleccione un reactor a incluir");
        return;
    }
    ...
    $.ajax({
        ...
        success: function (evt) {
            ...
            $("#btnSeleccionar").click(function () {
                ...
                window.location.href = controlador + "IncluirModificar?idReactor=0&idProyecto=" + idProyecto + "&idEquipo=" + id + "&accion=Incluir";
            });
