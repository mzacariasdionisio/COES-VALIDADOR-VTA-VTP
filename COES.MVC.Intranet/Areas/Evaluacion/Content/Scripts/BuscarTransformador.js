...
let consultar = function () {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            type: 'POST',
            url: controlador + 'BuscarTransformadorLista?equiCodi=' + equiCodi + "&codigo=" + codigo + "&tipo=" + tipo + "&ubicacion=" + ubicacion + "&empresa=" + emprCodigo + "&estado=" + equiEstado,
...
function incluir(e) {
    ...
    if (idEquipo == '') {
        alert("Seleccione un transformador a incluir");
        return;
    }
    ...
    $.ajax({
        ...
        success: function (evt) {
            ...
            $("#btnSeleccionar").click(function () {
                ...
                window.location.href = controlador + "IncluirModificar?idTransformador=0&idProyecto=" + idProyecto + "&idEquipo=" + id + "&accion=Incluir";
            });
