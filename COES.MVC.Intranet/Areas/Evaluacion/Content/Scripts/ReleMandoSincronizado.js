...
$(function () {
    ...
    $('#btnConsultar').click(function () {
        consultarReleMandoSincronizado();
    });
...
function consultarReleMandoSincronizado() {
    consultar();
}
...
let consultar = function () {
    ...
    setTimeout(function () {
        $.ajax({
            type: 'POST',
            url: controlador + 'ListaReleMandoSincronizado?codigoId=' + codigoId + "&codigo=" + codigo + "&subestacion=" + subestacion + "&celda=" + celda + "&empresa=" + empresa + "&area=" + area + "&estado=" + estado,
...
function consultarEquipo(codigoId) {
    window.location.href = siteRoot + "Evaluacion/Transversal/IndexConsultarEquipo?codigoId=" + codigoId + "&pathReturn=Evaluacion-Rele-IndexReleMandoSincronizado";
};

function historialCambio(codigoId) {
    window.location.href = siteRoot + "Evaluacion/Transversal/IndexHistorialCambio?codigoId=" + codigoId + "&pathReturn=Evaluacion-Rele-IndexReleMandoSincronizado";
};
...
let exportar = function () {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            type: 'POST',
            url: controlador + 'ExportarReleMandoSincronizado?codigoId=' + codigoId + "&codigo=" + codigo + "&subestacion=" + subestacion + "&celda=" + celda + "&empresa=" + empresa + "&area=" + area + "&estado=" + estado,
            success: function (evt) {
                if (evt.Resultado != "-1") {
