...
function consultarReleSincronismo() {
    consultar();
}
...
let consultar = function () {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            type: 'POST',
            url: controlador + 'ListaReleSincronismo?codigoId=' + codigoId + "&codigo=" + codigo + "&subestacion=" + subestacion + "&celda=" + celda + "&empresa=" + empresa + "&area=" + area + "&estado=" + estado,
...
function consultarEquipo (codigoId) {
    window.location.href = siteRoot + "Evaluacion/Transversal/IndexConsultarEquipo?codigoId=" + codigoId + "&pathReturn=Evaluacion-Rele-IndexReleSincronismo";
};

function historialCambio(codigoId) {
    window.location.href = siteRoot + "Evaluacion/Transversal/IndexHistorialCambio?codigoId=" + codigoId + "&pathReturn=Evaluacion-Rele-IndexReleSincronismo";
};
...
let exportar = function () {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            type: 'POST',
            url: controlador + 'ExportarReleSincronismo?codigoId=' + codigoId + "&codigo=" + codigo + "&subestacion=" + subestacion + "&celda=" + celda + "&empresa=" + empresa + "&area=" + area + "&estado=" + estado,
            success: function (evt) {
                if (evt.Resultado != "-1") {
