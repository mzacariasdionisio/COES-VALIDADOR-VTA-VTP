...
function consultarSobretension() {
    consultar();
}
...
let consultar = function () {
    ...
    setTimeout(function () {
        $.ajax({
            type: 'POST',
            url: controlador + 'ListaReleSobretension?codigoId=' + codigoId + "&codigo=" + codigo + "&subestacion=" + subestacion + "&celda=" + celda + "&empresa=" + empresa + "&area=" + area + "&estado=" + estado,
...
function consultarEquipo(codigoId) {
    window.location.href = siteRoot + "Evaluacion/Transversal/IndexConsultarEquipo?codigoId=" + codigoId + "&pathReturn=Evaluacion-Rele-IndexReleSobretension";
};

function historialCambio(codigoId) {
    window.location.href = siteRoot + "Evaluacion/Transversal/IndexHistorialCambio?codigoId=" + codigoId + "&pathReturn=Evaluacion-Rele-IndexReleSobretension";
};
...
let exportar = function () {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            type: 'POST',
            url: controlador + 'ExportarReleSobreTension?codigoId=' + codigoId + "&codigo=" + codigo + "&subestacion=" + subestacion + "&celda=" + celda + "&empresa=" + empresa + "&area=" + area + "&estado=" + estado,
            success: function (evt) {
                if (evt.Resultado != "-1") {
