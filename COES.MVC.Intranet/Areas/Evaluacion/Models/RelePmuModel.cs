...
namespace COES.MVC.Intranet.Areas.Evaluacion.Models
{
    ...
    public class ListadoRelePmuModel
    {
        public List<EprEquipoDTO> ListaRelePMU { get; set; }
}

    public class RelePmuEditarModel
    {
    ...
    public class RelePmuEliminarModel
    {
