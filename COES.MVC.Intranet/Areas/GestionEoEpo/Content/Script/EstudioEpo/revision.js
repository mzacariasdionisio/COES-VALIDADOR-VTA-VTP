...
function nuevaRevision(idepo, id, TipoConfig) {
    $.ajax({
        type: 'POST',
        dataType: 'json',
        url: controlador + "VerificarRevisionesEstudioEPO",
        data: {
            epocodi: idepo
        },
        success: function (evt) {
            if (evt == "" || id != 0) {
                window.location = controlador + "NuevaRevision?epocodi=" + idepo + "&id=" + id + "&TipoConfig=" + TipoConfig;
            }
            else {
...
/*Fin Mejoras EO - EPO*/
function ConfirmarEliminar(id, epocodi) {
    mostrarConfirmacion("¿Desea eliminar el registro seleccionado?", EliminarRevision, id, epocodi);
}
...
function EliminarRevision(id) {
    $.ajax({
        type: 'POST',
        dataType: 'json',
        url: controlador + "EliminarRevisionEPO",
        data: {
            revcodi: id[0]
        },
        success: function (evt) {
