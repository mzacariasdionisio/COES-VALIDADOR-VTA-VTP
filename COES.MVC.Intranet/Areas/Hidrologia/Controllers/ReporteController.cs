...
namespace COES.MVC.Intranet.Areas.Hidrologia.Controllers
{
    public class ReporteController : Controller
    {
            ...
            int opcion, int rbDetalleRpte, int unidad)
        {
            ...
            string resultado = this.logic.ObtenerReporteHidrologia(idsEmpresa, idsCuenca, idsFamilia, idsPtoMedicion, fechaIni, fechaFin, idLectura, opcion, rbDetalleRpte, unidad, numeroMedicion);
