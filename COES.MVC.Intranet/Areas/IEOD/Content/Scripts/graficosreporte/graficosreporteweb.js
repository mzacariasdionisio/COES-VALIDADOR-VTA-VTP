            ...
            if (data.Resultado != "-1") {
                ...
                setTimeout(function () {
                    $('#tbl_hoja').dataTable({
                        ...
                        "iDisplayLength": -1,
                        "language": {
                            "emptyTable": "¡No existen reportes!"
                        },
                    });
                }, 150);
    ...
    $.ajax({
        ...
        success: function (model) {
            if (model.Resultado != "-1") {
                ...
                if (reporcodi == 58) // Inf. Semanal 5.2. Evolucion de volumenes de embalses y lagunas (Mm3)
                { mostrarVolUtilListadoGrafico(2); }
                if (reporcodi == 60) //Inf. Semanal 5.4. Evolución de los caudales
                { mostrarPromedioCaudales(2); }
                if (reporcodi == 33) //Inf. Ejecutivo Semanal 4.2. Evolucion de volumenes de embalses y lagunas (Mm3)
                { mostrarVolUtilListadoGrafico(2) }
                if (reporcodi == 35) //Inf. Ejecutivo Semanal 4.4. Evolución de los caudales
