...
namespace COES.MVC.Intranet.Areas.IndicadoresSup.Models
{
    public class Siosein2Model
    {
        ...
        public List<SelectListItem> ListItemSelect { get; internal set; }

        public List<int> Conceptos { get; set; } = new List<int>();
