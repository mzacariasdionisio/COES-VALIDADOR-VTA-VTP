...
{    
    /// <summary>
    /// Contiene los campos con los que se filtra el listado de importaciones
    /// </summary>
    public class FiltroListadoPeriodosImportacionModel
    {
        [Display(Name = "Año: ")]
        ...
        public FiltroListadoPeriodosImportacionModel(IEnumerable<string> aniosList, string anioActual)
        {
