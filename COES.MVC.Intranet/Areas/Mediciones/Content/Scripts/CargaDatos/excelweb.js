var controlador = siteRoot + 'mediciones/cargadatos/';
var uploader;
var totNoNumero = 0;
var totLimSup = 0;
var totLimInf = 0;
    ...
    $.ajax({
        ...
        success: function (evt) {
            if (evt != -1) {
                ...
                mostrardetalleExcel(evtHot.ListaEnvios.length);
            }
            else {
...
function mostrardetalleExcel(envios) {
    if (evtHot.Handson.TieneData == 1) {
        $('#infoMensaje').css("display", "block");
        if (envios > 0) {
            mensaje = "<strong><font style='color:SteelBlue;'>&nbsp;&nbsp;&nbsp;Información RER actualizada por el administrador</strong>";
        }
        else {
            mensaje = "<strong><font style='color:SteelBlue;'>&nbsp;&nbsp;&nbsp;Información RER cargada desde los agentes</strong>";
        }
    } 
    $("#infoMensaje").html(mensaje);
}
...
function crearPupload() {
    uploader = new plupload.Uploader({
        ...
        url: siteRoot + 'mediciones/cargadatos/Upload',
