...
const ValFechaProceso = "{FECHA_PROCESO}";
const ValNombreUsuario = "{NOMBRE_USUARIO}";
const ValFechaSistema = "{FECHA_SISTEMA}";

var listaTodasLasVariablesCorreo = [
    ValFechaProceso, ValNombreUsuario, ValFechaSistema
];

var lstVariablesPara = [
    ValFechaProceso, ValFechaSistema
];
...
function listarVariableCorreo() {
    ...
    lista.push({
        Valor: ValFechaProceso,
        Nombre: 'Día proceso - {FECHA_PROCESO}'
    });

    lista.push({
        Valor: ValFechaSistema,
        Nombre: 'Fecha y hora de sistema - {FECHA_SISTEMA}'
    });

    lista.push({
        Valor: ValNombreUsuario,
        Nombre: 'Nombre de usuario - {NOMBRE_USUARIO}'
    });
...
function dibujarPlantilla(objPlantilla, plantillacodi, accion, tipoEnvio, tipoCorreo) {
    ...
    cadena += `
                    <tr>
                        ...
                        <td class="registro-control" style="width:1100px;"><input type="text" name="To" id="To" value="${val_To}" maxlength="200" style="width:1090px;" 
    ...
    cadena += `
            <tr>
                ...
                <td class="registro-control" style="width:1100px;"><input name="CC" id="CC" type="text" value="${val_CC}" maxlength="200" style="width:1090px;"  
            ...
            <tr>
                ...
                <td class="registro-control" style="width:1100px;"><input name="BCC" id="BCC" type="text" value="${val_BCC}" maxlength="200" style="width:1090px;" 
