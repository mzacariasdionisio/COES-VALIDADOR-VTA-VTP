var controlador = siteRoot + 'Indisponibilidades/Indisponibilidades/'
...
var errorNoOsinergCodi = 9;
var errorNoUnidadOsinergCodi = 10;
var errorHoraIniMayFin = 11;
var errorHoraIniMenHoraPunta = 12;
var errorHoraFinMayHoraPunta = 13;
var maxCadena = 255;
var columnas = [
    {
        central: 0,
...
var errores = [    
    ...
    {
        tipo: 'NONUMERO',
        Descripcion: 'Numero ingresado INCORRECTO',
        total: 0,
        codigo: 2,
        BackgroundColor: 'red',
        Color: 'white'
    ...
    {
        tipo: 'NOOSINERGCODI',
        Descripcion: 'Codigo OSINERG NO EXISTE',
        total: 0,
        codigo: 9,
        BackgroundColor: 'red',
        Color: 'white'
    ...
    {
        tipo: 'NOUNIDADOSINERGCODI',
        Descripcion: 'Unidad o Codigo OSINERG ingresada NO EXISTE',
        total: 0,
        codigo: 10,
        BackgroundColor: '#FF4C42',
        Color: 'black'
    ...
    {
        tipo: 'HORAINIMAYFIN',
        Descripcion: 'La hora inicial es mayor que la final',
        total: 0,
        codigo: 11,
        BackgroundColor: '#FF4C42',
        Color: 'black'
    ...
    {
        tipo: 'HORAINIMENHORAPUNTA',
        Descripcion: 'La hora inicial es menor que hora punta inicial',
        total: 0,
        codigo: 12,
        BackgroundColor: '#FF4C42',
        Color: 'black'
    ...
    {
        tipo: 'HORAFINMAYHORAPUNTA',
        Descripcion: 'La hora fin es mayor que la hora punta fin',
        total: 0,
        codigo: 13,
        BackgroundColor: '#FF4C42',
        Color: 'black'
...
function dibujarTablaErrorFort() {
    var cadena = "<div style='clear:both; height:5px'></div> ";
    cadena += "<table id='tablaErrorFort' border='1' class='pretty tabla-adicional' cellspacing='0'>";
    cadena += "<thead><tr><th>Celda</th><th>Valor</th><th>Tipo Error</th></tr></thead>";
    cadena += "<tbody>";
    var len = listErrores.length;
    for (var i = 0 ; i < len ; i++) {
...
function dibujarTablaErrorProg() {
    var cadena = "<div style='clear:both; height:5px'></div> ";
    cadena += "<table id='tablaErrorProg' border='1' class='pretty tabla-adicional' cellspacing='0'>";
    cadena += "<thead><tr><th>Celda</th><th>Valor</th><th>Tipo Error</th></tr></thead>";
    cadena += "<tbody>";
    var len = listErrores.length;
    for (var i = 0 ; i < len ; i++) {
    ...
    if (index != -1) {
        ...
        switch (tipoError) {
            ...
            case errorNoUnidadOsinergCodi:
                ...
                break;
            case errorHoraIniMayFin:
                errores[errorHoraIniMayFin].total--;
                break;
            case errorHoraFinMayHoraPunta:
                errores[errorHoraFinMayHoraPunta].total--;
                break;
            case errorHoraIniMenHoraPunta:
                errores[errorHoraIniMenHoraPunta].total--;
                break;
        }
    }
}
...
function dibujarTablaEnvios(lista) {
    ...
    for (key in lista) {
        ...
        cadena += "<tr onclick='mostrarEnvioTablaPrie01(" + lista[key].Enviocodi + ");' style='cursor:pointer'><td>" + lista[key].Enviocodi + "</td>";
...
var Tipo = {
    TotalesTermicoFort: 1,
    TotalesTermicoProg: 2,
    ParcialesTermicoFort: 3,
    ParcialesTermicoProg: 4,
    TotalesHidroFort: 5,
    TotalesHidroProg: 6,
    FactorK: 7,
    DisponibilidadDiariaHidro: 8,
    PotenciaAsegxDia: 9,
    CompensacionPruebaAle: 10,
    Cuadro7xAnno: 11,
    Cuadro7xMes: 12,
    Cuadro7xSemana: 13
}
