    ...
    $.ajax({
        ...
        success: function (model) {
            if (model.Resultado != "-1") {
                ...
                window.location.href = controlador + 'descargarformato?archivo=' + model.Resultado;
            }
            else {
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.Resultado == "1") {
                ...
                mostrarEventoError(numHoja, "Error: " + res.Mensaje);
            }
        },
        error: function (err) {
    ...
    $.ajax({
        ...
        success: function (evt) {
            if (evt.Resultado != "-1") {
                ...
                if (idEnvio == 0) {
                    //alert("No existe actualización de datos. Los datos no se grabaron en el sistema.");
