var controlador = siteRoot + 'pronosticodemanda/despachoejecutado/';
...
ejecutar = function () {
    ...
    $.ajax({
        type: 'POST',
        url: controlador + 'ObtenerDespachoEjecutado',
        data: { fecha: sFecha },
        dataType: 'json',
...
pintar = function (equicodi, fecha)
{
    $.ajax({
        type: 'POST',
...
modificarDE = function () {
    ...
    else
    {
        ...
        $.ajax({
            type: 'POST',
            url: controlador + 'GrabarPronostico',
