$(document).ready(function () {
    ...
    dt = $('#dtgrid').DataTable({
        ...
        columns: [
            ...
            { title: 'EMIN(%)', data: 'Prncfgporcerrormin' },
            { title: 'EMAX(%)', data: 'Prncfgporcerrormax' },
            { title: 'MCMIN(MW)', data: 'Prncfgmagcargamin' },
            { title: 'MCMAX(MW)', data: 'Prncfgmagcargamax' },
            { title: 'DSVPATRON(%)', data: 'Prncfgporcdsvptrn' },
            { title: 'MUESTRA(%)', data: 'Prncfgporcmuestra' },
            { title: 'DSV(%)', data: 'Prncfgporcdsvcnsc' },
            { title: 'NCOIN(#)', data: 'Prncfgnrocoincidn' },
            { title: 'VEDA', data: 'Prncfgflagveda' },
            { title: 'FERIADO', data: 'Prncfgflagferiado' },
            { title: 'ATÍPICO', data: 'Prncfgflagatipico' },
            { title: 'DEPAUTO', data: 'Prncfgflagdepauto' },
            { title: 'PATRON', data: 'Prncfgtipopatron' },
            { title: 'NDPTRN', data: 'Prncfgnumdiapatron' },
            { title: 'PTRNDEF', data: 'Prncfgflagdefecto' },
        ...
        success: function (result) {
            switch (id) {
                ...
                case 'id-subestacion':
                    ...
                    RefillDropDowList($('#id-punto'), result.ListPtomedicion, 'Ptomedicodi', 'FullPtomedidesc');
                    break;
                case 'id-empresa':
                    //Actualiza la lista de puntos de medición
                    RefillDropDowList($('#id-punto'), result.ListPtomedicion, 'Ptomedicodi', 'FullPtomedidesc');
...
function GetFiltersValues() {
    ...
    model['SelSubestacion'] = $('#id-subestacion').val();
...
////Validación para el evento - 'resize' de la ventana(explorador) - Outdate
//window.addEventListener("resize", EndEventTimer(function (e) {
//    if (dt) {
//        var x = $('#dtgrid').width();
//        $('.dataTables_scrollHeadInner table').css('width', x + 'px');
//    }
//}));
////Validación para el evento - 'hide' del menu COES
//document.getElementById('btnOcultarMenu').addEventListener('click', function () {
//    if (dt) {
//        var x = $('#dtgrid').width();
//        $('.dataTables_scrollHeadInner table').css('width', x + 'px');
//    }
