...
validarExcelWeb = function (data, rowini, colini) {
    ...
    if (data[1][1] != null && data[1][1] != "") {
        ...
        if (!loFechaInicio) {
            mostrarAlerta("La fecha inicio de Levantamiento de Observaciones es inválido.");
            return false;
        }
    }
    ...
    if (data[1][1] != null ) {
        ...
        if (data[2][1] == "") {
            mostrarAlerta("Si se ha ingresado la fecha de inicio de Levantamiento de Observaciones del Titular del Proyecto, debe ingresar el título");
            return false;
        }
    ...
    if (data[5][1] != null && data[5][1] != "") {
        ...
        if (!loFechaFin) {
            mostrarAlerta("La fecha fin de Levantamiento de Observaciones es inválido.");
            return false;
        }
    }
    
    if (data[7][1] != null && data[7][1] != "") {
        var eetiFechaInicio = isDate(new Date(getFechaYYYYMMDD(data[7][1], "-")));
        if (!eetiFechaInicio) {
    ...
    if (data[11][1] != null && data[11][1] != "") {
        var eetiFechaFin = isDate(new Date(getFechaYYYYMMDD(data[11][1], "-")));
        if (!eetiFechaFin) {
    ...
    if (data[13][1] != null && data[13][1] != "") {
        var rtiFechaInicio = isDate(new Date(getFechaYYYYMMDD(data[13][1], "-")));
        if (!rtiFechaInicio) {
    ...
    if (data[17][1] != null && data[17][1] != "") {
        var rtiFechaFin = isDate(new Date(getFechaYYYYMMDD(data[17][1], "-")));
        if (!rtiFechaFin) {
