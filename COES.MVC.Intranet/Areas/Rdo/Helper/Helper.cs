...
namespace COES.MVC.Intranet.Areas.Rdo.Helper
{
    public class Util
    {
        ...
        public static void GenerarFileExcelConsumo(DisponibilidadCombustibleFormatoModel model, string rutaNombreArchivo)
        {
        ...
        /// <param name="model"></param>
        /// <param name="ruta"></param>
        public static void GenerarFileExcelDisponibilidad(DisponibilidadCombustibleFormatoModel model, string rutaNombreArchivo)
        {
            string fileExcel = string.Empty;
            FileInfo newFile = new FileInfo(rutaNombreArchivo);
