...
namespace COES.MVC.Intranet.Areas.Rdo.Models
{
    public class DisponibilidadCombustiblesModel
    {
    ...
    public class DisponibilidadCombustibleFormatoModel : FormatoModel
    {
        public Boolean EnabledStockInicio { get; set; }
        public List<decimal> ListaStockInicio { get; set; }
    }

    public class FiltroDisponibilidadCombustibleModel
    {
        public List<EqEquipoDTO> ListaCentral { get; set; }
