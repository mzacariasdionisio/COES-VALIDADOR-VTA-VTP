...
namespace COES.MVC.Intranet.Areas.RegistroIntegrante.Helper
{
    public class ExcelDocumentEmpresa
    {
        ...
        public static void ConfiguracionHojaExcel(ExcelWorksheet ws, string ruta)
        {
            ...
            ws.Cells[4, 6].Value = "PARTIDA REGISTRAL";
            ws.Cells[4, 7].Value = "SIGLA";
            ws.Cells[4, 8].Value = "RAZON SOCIAL";
            ws.Cells[4, 9].Value = "NOMBRE EMPRESA COMERCIAL";
            ws.Cells[4, 10].Value = "REPRESENTANTE LEGAL";
            ws.Cells[4, 11].Value = "CORREO ELECTRÓNICO";
            ws.Cells[4, 12].Value = "TELÉFONO";
            ws.Cells[4, 13].Value = "CONDICIÓN";
        ...
        public static void GernerarArchivoEnvios(List<SiEmpresaDTO> list, string ruta, string titulo)
        {
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(newFile))
            {
                ...
                foreach (var reg in list)
                {
                    ...
                    ws.Cells[row, column + 4].Value = reg.Emprnumpartidareg == null ? "" : reg.Emprnumpartidareg.ToString();
                    ws.Cells[row, column + 4].AutoFitColumns();
                    ws.Cells[row, column + 5].Value = reg.Emprsigla == null ? "" : reg.Emprsigla.ToString();
                    ws.Cells[row, column + 5].AutoFitColumns();

                    ws.Cells[row, column + 6].Value = reg.Emprrazsocial == null ? "" : reg.Emprrazsocial.ToString();
                    ws.Cells[row, column + 6].AutoFitColumns();
                    ws.Cells[row, column + 7].Value = reg.Emprnombrecomercial == null ? "" : reg.Emprnombrecomercial.ToString();
                    ws.Cells[row, column + 7].AutoFitColumns();
                    ws.Cells[row, column + 8].Value = reg.RpteNombres == null ? "" : reg.RpteNombres.ToString();
                    ws.Cells[row, column + 8].AutoFitColumns();
                    ws.Cells[row, column + 9].Value = reg.RpteCorreoElectronico == null ? "" : reg.RpteCorreoElectronico.ToString();
                    ws.Cells[row, column + 9].AutoFitColumns();
                    ws.Cells[row, column + 10].Value = reg.RpteTelefono == null ? "" : reg.RpteTelefono.ToString();
                    ws.Cells[row, column + 10].AutoFitColumns();
                    ws.Cells[row, column + 11].Value = reg.Modalidad == null ? "" : reg.Modalidad.ToString();
    ...
    public class ExcelDocumentRepresentantesLegales
    {
        ...
        public static void ConfiguracionHojaExcel(ExcelWorksheet ws, string ruta)
        {
            ...
            ws.Cells[4, 8].Value = "REPRESENTANTE LEGAL";
            ws.Cells[4, 9].Value = "CORREO ELECTRÓNICO";
            ws.Cells[4, 10].Value = "DOCUMENTO IDENTIDAD";
            ws.Cells[4, 11].Value = "TELÉFONO";
            ws.Cells[4, 12].Value = "VIGENCIA PODER";
            ws.Cells[4, 13].Value = "ESTADO BAJA";
        ...
        public static void GernerarArchivoEnvios(List<SiEmpresaDTO> list, string ruta, string titulo)
        {
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(newFile))
            {
                ...
                foreach (var reg in list)
                {
                    ...
                    ws.Cells[row, column + 7].Value = reg.RpteCorreoElectronico == null ? "" : reg.RpteCorreoElectronico.ToString();
                    ws.Cells[row, column + 7].AutoFitColumns();
                    ws.Cells[row, column + 8].Value = reg.RpteDocIdentidad == null ? "" : reg.RpteDocIdentidad.ToString();
                    ws.Cells[row, column + 8].AutoFitColumns();
                    ws.Cells[row, column + 9].Value = reg.RpteTelefono == null ? "" : reg.RpteTelefono.ToString();
                    ws.Cells[row, column + 9].AutoFitColumns();
                    ws.Cells[row, column + 10].Value = reg.RpteFechaVigenciaPoder == null ? "" : reg.RpteFechaVigenciaPoder.Value.ToString(ConstantesBase.FormatoFecha);
                    ws.Cells[row, column + 10].AutoFitColumns();
                    ws.Cells[row, column + 11].Value = reg.RpteBaja == null ? "" : (reg.RpteBaja.ToString() == ConstantesRegistroIntegrantes.RepresentanteBajaSi ? "SI" : "N0");
                    ws.Cells[row, column + 11].AutoFitColumns();
