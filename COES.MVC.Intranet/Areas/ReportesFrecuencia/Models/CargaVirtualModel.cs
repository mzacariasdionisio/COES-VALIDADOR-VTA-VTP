...
{
    public class CargaVirtualModel
    {
        public bool bEditar { get; set; }
        public bool bNuevo { get; set; }
        public bool bEliminar { get; set; }
        public bool bGrabar { get; set; }
        public List<CargaVirtualDTO> ListaCargaVirtual { get; set; }
        public List<SiEmpresaDTO> ListaEmpresas { get; set; }
        public List<EquipoGPSDTO> ListaEquipos { get; set; }
        public List<LecturaVirtualDTO> ListaLecturaVirtual { get; set; }
        public CargaVirtualDTO Entidad { get; set; }
