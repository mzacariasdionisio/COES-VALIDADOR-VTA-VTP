...
namespace COES.MVC.Intranet.Areas.Resarcimientos.Controllers
{
    ...
    /// </summary>
    public class ReporteHistoricoController : Controller
    {
        ...
        /// </summary>
        public ActionResult Default(FormCollection collection)
        {
            try
            {
                ...
                permodel.ListaPeriodo = ntcse.ListComboRntPeriodos();
                permodel.ListaPeriodo.Add(permodel.ListaComboTodos);

                //Iniciando Periodo Consulta
                if (permodel != null)
                {
                    b.Periodo = permodel.ListaPeriodo[0].PeriodoCodi;
                }
                ...
                PEntregaModel pemodel = new PEntregaModel();
                pemodel.ListBarras = ntcse.ListBarras(); //ListSubEstacion(b.EmpresaGeneradora, periodo, b.Cliente);
                pemodel.ListBarras.Insert(0, pemodel.ListaComboSeleccionar);
                ViewData["CboPuntoEntrega"] = new SelectList(pemodel.ListBarras, "Barrcodi", "BarrNombre", 0);
                ...
                try
                {
                    if (User != null)
                    {
                        List<RntRegPuntoEntregaDTO> urs = this.ntcse.ListReporteCargaRntRegPuntoEntregas(empresaGeneradora, periodo, puntoEntrega, codigoEnvio);
        ...
        /// <summary>
        /// En la Intranet muestra lista de registros de resarcimientos de Punto de Entrega y Rechazo de Carga 
        /// en la tabla de envios.
        /// </summary>
        public JsonResult Consultar(FormCollection collection)
        {
            ...
            int codigoEnvio = Convert.ToInt32(Request["codigoEnvio"] == "" ? "0" : Request["codigoEnvio"]);
            ...
            object[] objResponse = { listR.ListTable };
        ...
        /// <summary>
        /// Consultar información de resarcimientos de Punto de Entrega y Rechazo de Carga
        /// por CodigoEnvio para mostrar el resultado en la grilla Handsontable.
        /// </summary>
        [HttpPost]
        ...
        /// <summary>
        /// Obtiene los valores de los combos
        /// </summary>
        public JsonResult TraerParametros(FormCollection collection)
        {
            ...
            arrCliente = new string[listClientes.Count];
            for (int i = 0; i < listClientes.Count; i++)
                arrCliente[i] = listClientes[i].Emprnomb;
            ...
            arrBarra = new string[listBarras.Count];
            for (int i = 0; i < listBarras.Count; i++)
                arrBarra[i] = listBarras[i].BarrNombre;
        ...
        /// <summary>
        /// Descarga a un archivo Excel la información de resarcimientos de Punto de Entrega y Rechazo de Carga
        /// que se encuentra almacenada en la grilla Handsontable
        /// </summary>
        [HttpGet]
        ...
        /// <summary>
        /// Permite obtener de la grilla Handsontable información de resarcimientos de Punto de Entrega y Rechazo de Carga
        /// para luego generar un archivo Excel.
        /// </summary>
        [HttpPost]
        public string GenerarExcel(FormCollection collection)
        {
            ...
            using (ExcelPackage pck = new ExcelPackage())
            {
                ...
                for (int i = intColumnaInicio, j = intColumnaFin; i <= j; i++)
                {
                    ...
                    if ((i >= intColumnaInicio && i <= intColumnaInicio + 9) || (i >= intColumnaInicio + 24 && i <= intColumnaInicio + 26))
                    {
                ...
                if (arrFila.Length > 0)
                {
                    ...
                    string strID = null,
                        ...
                        strTiempoProgramadoInicio = null,
                        strTiempoProgramadoFin = null;
                    ...
                    objHojaPE.Cells[intFilaInicio, intColumnaInicio + 10, intFilaFin, intColumnaInicio + 13].Style.Numberformat.Format = "dd/mm/yyyy HH:mm";
                ...
                intColumnaFin = intColumnaInicio + 13;
                ...
                if (arrFila.Length > 0)
                {
                            ...
                            switch (m)
                            {
                                ...
                                case 9:
                                    if (strValue != null && strValue.Trim().Length > 0)
                                    {
                                        ...
                                        {
                                            objHojaRC.SetValue(i + intFilaInicio, m + intColumnaInicio, dteValue);
                                        }
                                        else
                                        {
                                            objHojaRC.SetValue(i + intFilaInicio, m + intColumnaInicio, strValue);
                    ...
                    objHojaRC.Cells[intFilaInicio, intColumnaInicio + 8, intFilaFin, intColumnaInicio + 9].Style.Numberformat.Format = "dd/mm/yyyy HH:mm";

                    objHojaRC.Cells[intFilaInicio, intColumnaInicio + 10, intFilaFin, intColumnaInicio + 11].Style.Numberformat.Format = "#";
