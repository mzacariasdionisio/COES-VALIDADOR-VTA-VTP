...
namespace COES.MVC.Intranet.Areas.ServicioRPF.Controllers
{
    public class ComparativoController : BaseController
    {
        ...
        /// <param name="fecha"></param>
        /// <returns></returns>
        private List<ComparativoItemModel> CalcularComparativo(int? idEmpresa, int? idCentral, string fecha)
        {
            ...
            List<ComparativoItemModel> list = ComparativoHelper.ObtenerComparativo(fechaConsulta, datosRpf, datosDespacho);
        ...
        public JsonResult Exportar(int? idEmpresa, int? idCentral, string fecha)
        {
            try
            {
                ...
                List<ComparativoItemModel> comparativo = this.CalcularComparativo(idEmpresa, idCentral, fecha);
        ...
        public JsonResult ExportarRPF(string fecha)
        {
            try
            {
                ...
                List<ServicioCloud.Medicion> list = (new ServicioCloud.ServicioCloudClient()).ObtenerDatosComparacion(fechaConsulta, ptomedicodi).ToList();
