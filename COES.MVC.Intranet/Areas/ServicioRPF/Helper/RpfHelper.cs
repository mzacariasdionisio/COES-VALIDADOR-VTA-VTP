...
namespace COES.MVC.Intranet.Areas.ServicioRPF.Helper
{
    ...
    public class RpfHelper
    {
        ...
        public SerieGraficoRpf ObtenerGrafico(decimal ajuste, List<RegistroRPF> list, ServicioRpfDTO itemPotencia)
        {
        ...
        /// <param name="ajuste"></param>
        /// <returns></returns>
        public List<ServicioRpfDTO> ObtenerReporte(List<ServicioRpfDTO> listConfiguracion, List<RegistroRPF> listDatos,
            List<ServicioRpfDTO> listPotencia, decimal ajuste)
        {
            ...
            {
                List<RegistroRPF> list = listDatos.Where(x => x.PTOMEDICODI == item.PTOMEDICODI).ToList();
        ...
        /// <param name="ajuste"></param>
        /// <returns></returns>
        public List<ServicioRpfDTO> ObtenerReporteWord(List<ServicioRpfDTO> listConfiguracion, List<RegistroRPF> listDatos,
            List<ServicioRpfDTO> listPotencia, decimal ajuste)
        {
            List<ServicioRpfDTO> listReporte = listConfiguracion;
        ...
        /// <param name="ajuste"></param>
        /// <param name="list"></param>
        public SerieGraficoRpf ObtenerGraficoFalla(decimal ra, List<RegistroRPF> listDatos, int indice, List<decimal> sanjuan)
        {
            SerieGraficoRpf grafico = new SerieGraficoRpf();
            StringBuilder regresion = new StringBuilder();
            StringBuilder puntos = new StringBuilder();
            ...
            List<RegistroRPF> list = listDatos.Skip(10).ToList();
            List<RegistroRPF> listAnterior = listDatos.Take(10).ToList();
        ...
        /// <returns></returns>
        public List<ServicioRpfDTO> ObtenerReporteFalla(List<ServicioRpfDTO> listConfiguracion, List<RegistroRPF> listDatos,
            List<ServicioRpfDTO> listPotencias, int indiceFrecuencia)
        {
            ...
            {
                List<RegistroRPF> list = listDatos.Where(x => x.PTOMEDICODI == item.PTOMEDICODI).OrderBy(x => x.FECHAHORA).Skip(10).ToList();
                ...
                if (list.Count >= 60)
                {
                    if (list[0].FRECUENCIA > 0)
                    {
                        ...
                        if (itemPotencia != null)
                        {
                            ...
                            List<RegistroRPF> listFrec = listDatos.Where(x => x.PTOMEDICODI == item.PTOMEDICODI).OrderBy(x => x.FECHAHORA).Take(10).ToList();
                            decimal frecFalla = 0;
        ...
        /// <returns></returns>
        public List<ServicioRpfDTO> ObtenerReporteWordRPF(List<ServicioRpfDTO> listConfiguracion, List<RegistroRPF> listDatos,
            List<ServicioRpfDTO> listPotencias, int indiceFrecuencia,  List<decimal> frecuencias)
        {
            ...
            {
                List<RegistroRPF> list = listDatos.Where(x => x.PTOMEDICODI == item.PTOMEDICODI).OrderBy(x => x.FECHAHORA).Skip(10).ToList();
                List<RegistroRPF> listInicial = listDatos.Where(x => x.PTOMEDICODI == item.PTOMEDICODI).OrderBy(x => x.FECHAHORA).Take(10).ToList();
                ServicioRpfDTO itemPotencia = listPotencias.Where(x => x.PTOMEDICODI == item.PTOMEDICODI).FirstOrDefault();
