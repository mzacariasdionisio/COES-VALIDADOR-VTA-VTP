...
namespace COES.MVC.Intranet.Areas.ServicioRPFNuevo.Controllers
{
    public class AnalisisNormalController : BaseController
    {
        ...
        /// </summary>
        public List<RegistrorpfDTO> ListaNoIncluida
        {
            get
            {
                return (Session[DatosSesion.ListaNoIncluir] != null) ?
                    (List<RegistrorpfDTO>)Session[DatosSesion.ListaNoIncluir] : new List<RegistrorpfDTO>();
            }
        ...
        /// </summary>
        public List<RegistrorpfDTO> ListaGrafico
        {
            get
            {
                return (Session[DatosSesion.ListaGrafico] != null) ?
                    (List<RegistrorpfDTO>)Session[DatosSesion.ListaGrafico] : new List<RegistrorpfDTO>();
            }
        ...
        public PartialViewResult SeleccionRango(string fecha)
        {
            ...
            List<RegistrorpfDTO> resultado = this.logic.ObtenerDatosAnalisis(fechaProceso, ajuste, intentos, minimo, nroDatos, out idsCargaron,
        ...
        {
            AnalisisModel model = new AnalisisModel();
            List<RegistrorpfDTO> list = this.ListaDatos;

            double frecuencia = this.configuracion.ObtenerFiltroEvaluacion();

            List<RegistrorpfDTO> listIncluir = list.Where(x => x.FRECUENCIA > (decimal)frecuencia).ToList();
            List<RegistrorpfDTO> listNoIncluir = list.Where(x => x.FRECUENCIA <= (decimal)frecuencia).ToList();
        ...
        {
            AnalisisModel model = new AnalisisModel();
            List<RegistrorpfDTO> list = this.ListaNoIncluida;
        ...
        public JsonResult Grafico(int ptoMediCodi)
        {
            ...
            try
            {
                ...
                List<RegistrorpfDTO> list = this.ListaGrafico.Where(x => x.PTOMEDICODI ==
        ...
        public PartialViewResult Reporte()
        {
            ...
            List<RegistrorpfDTO> listGrafico = this.ListaGrafico;
            List<ServicioRpfDTO> listConfiguracion = this.ListaConfiguracion;
