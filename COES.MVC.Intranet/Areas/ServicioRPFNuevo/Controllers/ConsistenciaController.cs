    ...
    public class ConsistenciaController : Controller
    {
        ...
        public JsonResult ConsultarExistencia(string fecha)
        {
            ...
            try
            {
                ...
                List<ReporteEnvioDTO> resultado = logic.ObtenerReporteEnvio(fechaConsulta);
        ...
        public PartialViewResult Consulta(string fecha, int indicador)
        {
            ...
            List<ReporteEnvioDTO> resultado = null;
            ...
            if (indicador == 1)
            {
                ...
                if (frecuencias.Count == 86400)
                {
                    ...
                    try
                    {
                        int resul = logic.ConsultaEnvioDatos(fechaConsulta, frecuencias, porcentaje, potencia, percentil);

                        if (resul == 1)
                        {
                            resultado = logic.ObtenerReporteEnvio(fechaConsulta);
                        }
                    }
                    catch (Exception)
                    {
            ...
            if (resultado != null)
            {
                foreach (ServicioRpfDTO item in list)
                {
                    ...
                    foreach (ReporteEnvioDTO result in resultado)
                    {
