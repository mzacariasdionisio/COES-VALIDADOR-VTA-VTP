/*
 * SIMILAR A pr5cargarmenu.js
 */

var controlador = siteRoot + 'Siosein/InformesAnual/';

$(function () {
    cargarMenuFlotante(); //boton
        
    $('#openMenuSiosein').click(function () { //en cargarMenu.cshtml
        $('#contenedorMenuSiosein').slideToggle("slow");
    });

    $('#closeMenuSiosein').click(function () { //en cargarMenu.cshtml
    ...
    $('#btnRegresar').click(function () {
        var anio = $("#dtpAnio").val();
        document.location.href = controlador + 'MenuInformeAnual?anio=' + anio;
    });
...
function cargarMenuFlotante() {
    ...
    $.ajax({
        ...
        success: function (e) {
            ...
            $("#contenedorMenuInformeAnual").show();
            $('#MenuID').show();
        },
        error: function (err) {
...
function exportarExcelIndividual() {
    ...
    $.ajax({
        type: 'POST',
        url: controlador + 'GenerarReporteAnual',
        data: {
            reporcodi: reporcodi,
