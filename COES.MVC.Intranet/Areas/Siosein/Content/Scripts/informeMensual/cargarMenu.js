...
var controlador = siteRoot + 'Siosein/InformesMensual/'
...
$(function () {
    ...
    $('#btnRegresar').click(function () {
        ...
        document.location.href = controlador + 'MenuInformeMensual?mes=' + mesConsulta;
    });    
});
...
function cargarMenuFlotante() {
    ...
    $.ajax({
        ...
        success: function (e) {
            ...
            $("#contenedorMenuInformeMensual").show();
            $('#MenuID').show();
        },
        error: function (err) {
...
function exportarExcelIndividual() {
    ...
    $.ajax({
        type: 'POST',
        url: controlador + 'GenerarReporteMensualIndividual',
        data: {
