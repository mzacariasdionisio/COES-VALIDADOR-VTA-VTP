...
$(function () {
    ...
    //    if (window.confirm("El proceso de exportación a Excel del Informe Mensual puede tardar algunos minutos. ¿Desea continuar?")) {
    //        exportarExcel();
    //    }
    //});
...
function versionListado() {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.Resultado != "-1") {
                console.log("Informe mensual " + fechaPeriodo);
