...
$(function () {
    ...
    cargarListaDifusionVolumenEmbalses();
});
...
function viewGrafico(id) {
    ...
    $.ajax({
        type: 'POST',
        url: controlador + 'CargarViewGraficoDifusionVolumenEmbalses',
        ...
        success: function (data) {
            if (data.Grafico.Series.length > 0) {
                ...
                mostrarGrafico();
            } else { alert('Sin Grafico - No existen registros a mostrar!'); }
        },
        error: function () {
...
function cargarListaDifusionVolumenEmbalses() {
    ...
    $.ajax({
        type: 'POST',
        url: controlador + 'CargarListaDifusionVolumenEmbalses',
