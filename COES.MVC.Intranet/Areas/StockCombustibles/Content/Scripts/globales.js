...
function dibujarTablaError() {
    ...
    cadena += "<table id='tablaError' width='270px' border='1' class='pretty tabla-adicional' cellspacing='0'>";
...
function dibujarTablaEnvios(lista) {
    ...
    var cadena = "<div style='clear:both; height:5px'></div> ";
    cadena += "<table id='tablalenvio' border='1' width='280px' class='pretty tabla-adicional' cellspacing='0'>";
