var controlador = siteRoot + 'TiempoReal/ActualizacionSp7/';
...
$(function () {
    ...
    //$("#btnConsultar").persisteBusqueda("#frmBusquedaEquipo", buscarCambios,
    //    [
    //        { principal: "-2", dependiente: "cbEmpresa", accion: cargarCambios }
    //    ]);
...
mostrarListado = function (nroPagina) {
    ...
    $.ajax({
        type: 'POST',
        url: controlador + "ListadoCambios",
...
function exportarExcelActualizaciones() {
        $.ajax({
            type: 'POST',
            url: controlador + 'ExportarActualizacion',
            dataType: 'json',
            data: $('#frmBusquedaCambios').serialize(),
