...
{
    public class ActualizacionSp7Controller : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var modelo = new ActualizacionSp7Model();
        ...
        [HttpPost]
        public PartialViewResult ListadoCambios(ActualizacionSp7Model model)
        {
            ...
            var lstCambios = appTiempoReal.GetByFechaTrCanalcambioSp7s
                (fechaInicial.Date, fechaFinal.Date,
                model.NroPagina, Constantes.PageSizeEvento);
            lstCambios = appTiempoReal.FiltrarFilasEnBlanco(lstCambios);
            model.ListaActualizacion = lstCambios;
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult ExportarActualizacion(ActualizacionSp7Model filtro)
        {
            ...
            try
            {
                ...
                ConstantesAppServicio.FormatoFecha, CultureInfo.InvariantCulture),
                    ...
                    appTiempoReal.ExportarCambios(objFiltro, path, pathLogo, out fileNameSalidaTmp, out fileNameReporte);
