...
namespace COES.MVC.Intranet.Areas.TransfPotencia.Models
{
    public class GridExcelModel
    {
        ...
        public int esFormatoNuevo { get; set; }

        public List<SiEmpresaDTO> EmpresaList { get; set; }
        public List<EqEquipoDTO> CentralList { get; set; }
        public List<EqEquipoDTO> UnidadList { get; set; }
    }
}
