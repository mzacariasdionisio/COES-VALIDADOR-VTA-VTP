var controler = siteRoot + "transferencias/codigoentrega/";
...
function pintarPaginado() {
    ...
    $.ajax({
        ...
        data: { nombreEmp: $("#EMPRCODI option:selected").text(), centralGene: $("#CENTGENECODI option:selected").text(), nombreBarra: $("#BARRCODI option:selected").text(), fechaInicio: $('#txtfechaIni').val(), fechaFin: $('#txtfechaFin').val(), estado: estado, codentrega: $('#txtcodigoEntrega').val(), },
...
function mostrarListado(nroPagina) {
    ...
    $.ajax({
        type: 'POST',
        url: controler + "lista",
        data: { nombreEmp: $("#EMPRCODI option:selected").text(), centralGene: $("#CENTGENECODI option:selected").text(), nombreBarra: $("#BARRCODI option:selected").text(), fechaInicio: $('#txtfechaIni').val(), fechaFin: $('#txtfechaFin').val(), estado: estado,codentrega: $('#txtcodigoEntrega').val(), NroPagina: $('#hfNroPagina').val() },
        success: function (evt) {
