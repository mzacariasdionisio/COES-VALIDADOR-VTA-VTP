var controler = siteRoot + "transferencias/codigoretirosincontrato/";
...
function pintarPaginado() {
    ...
    $.ajax({
        ...
        data: { nombreCli: $("#EMPRCODI option:selected").text(), nombreBarra: $("#BARRCODI option:selected").text(), fechaInicio: $('#txtfechaIni').val(), fechaFin: $('#txtfechaFin').val(), estado: estado, codretirosc: $('#txtcodigoRetirosc').val() },
...
function mostrarListado(nroPagina) {
    ...
    $.ajax({
        type: 'POST',
        url: controler + "lista",
        data: { nombreCli: $("#EMPRCODI option:selected").text(), nombreBarra: $("#BARRCODI option:selected").text(), fechaInicio: $('#txtfechaIni').val(), fechaFin: $('#txtfechaFin').val(), estado: estado, codretirosc: $('#txtcodigoRetirosc').val(), NroPagina: $('#hfNroPagina').val() },
        success: function (evt) {
