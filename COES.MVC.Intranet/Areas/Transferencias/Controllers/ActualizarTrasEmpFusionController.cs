...
namespace COES.MVC.Intranet.Areas.Transferencias.Controllers
{
    public class ActualizarTrasEmpFusionController : BaseController
    {
        ...
        {
            ActualizarTrasEmpFusionModel model = new ActualizarTrasEmpFusionModel();
            model.ListaSaldosSobrantes = new ActualizarTrasEmpFusionAppServicio().GetListaSaldosSobrantes(pericodi, User.Identity.Name);
        ...
        {
            _ = new ActualizarTrasEmpFusionAppServicio().SaveOrUpdateSaldos(pericodi, items, User.Identity.Name);
        ...
        {
            _ = new ActualizarTrasEmpFusionAppServicio().SaveOrUpdateSaldosVTP(pericodi, items, User.Identity.Name);
            TempData["sMensajeExito"] = "La información ha sido correctamente registrada";
            return Json("");
        }
        [HttpPost]
        public ActionResult ListaSaldosNoIdentificados(int? pericodi)
        {
            ActualizarTrasEmpFusionModel model = new ActualizarTrasEmpFusionModel
            {
                ListaSaldosNoIdentificados = new ActualizarTrasEmpFusionAppServicio().GetListaSaldosNoIdentificados(pericodi)
            };
            return PartialView(model);
        }
    }
