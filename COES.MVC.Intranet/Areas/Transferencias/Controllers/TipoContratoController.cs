...
namespace COES.MVC.Intranet.Areas.Transferencias.Controllers
{
    public class TipoContratoController : Controller
    {
        ...
        {
            TipoContratoModel model = new TipoContratoModel();
            model.ListaTipoContrato = (new TipoContratoAppServicio()).BuscarTipoContrato(nombre);
        ...
        {
            TipoContratoModel model = new TipoContratoModel();
            model.Entidad = (new TipoContratoAppServicio()).GetByIdTipoContrato(id);
        ...
        public ActionResult Save([Bind(Include = "Tipocontcodi,Tipocontnombre, Tipocontestado")] TipoContratoDTO tipocont)
        {
            if (ModelState.IsValid)
            {
                ...
                TipoContratoModel model = new TipoContratoModel();
                model.idTipoContrato = (new TipoContratoAppServicio()).SaveOrUpdateTipoContrato(tipocont);
        ...
        {
            TipoContratoDTO dto = new TipoContratoDTO();
            dto = (new TipoContratoAppServicio()).GetByIdTipoContrato(id);
        ...
        {
            TipoContratoModel model = new TipoContratoModel();
            model.idTipoContrato = (new TipoContratoAppServicio()).DeleteTipoContrato(id);
            return "true";
        }
        ...
        public JsonResult GenerarExcel()
        {
            ...
            try
            {
                ...
                TipoContratoModel model = new TipoContratoModel();
                model.ListaTipoContrato = (new TipoContratoAppServicio()).BuscarTipoContrato("");
                ...
                using (ExcelPackage xlPackage = new ExcelPackage(newFile))
                {
                    ...
                    if (ws != null)
                    {   //TITULO
                        ws.Cells[2, 4].Value = "TIPOS DE CONTRATO";
                        ...
                        {
                            ws.Cells[row, 2].Value = item.TipoContCodi;
                            ws.Cells[row, 3].Value = (item.TipoContNombre != null) ? item.TipoContNombre : string.Empty;
                            ws.Cells[row, 4].Value = item.TipoContFecIns.ToString();
                            //Border por celda
        ...
        public virtual ActionResult AbrirExcel()
        {
            ...
            string path = ConfigurationManager.AppSettings[Funcion.ReporteDirectorio].ToString() + Funcion.NombreReporteTipoContratoExcel;
            var bytes = System.IO.File.ReadAllBytes(path);
            System.IO.File.Delete(path);

            return File(bytes, Constantes.AppExcel, sFecha + "_" + Funcion.NombreReporteTipoContratoExcel);
        }       
