...
namespace COES.MVC.Intranet.Areas.Transferencias.Models
{
    ...
    public class GrillaExcelModel
    {
        ...
        public object[] ListaTipoUsuario { get; set; }
        public object[] ListaLicitacion { get; set; }
        public object[] ListaCalidad { get; set; }
        ...
        public string TrnEnvFecIns { get; set; }
        public decimal LimiteMaxEnergia { get; set; }

        //ASSETEC 201200626
        public string sCodigoErroneo { get; set; }
        public string sCodigoFaltante { get; set; }
    }
}