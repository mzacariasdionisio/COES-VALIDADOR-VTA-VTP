...
namespace COES.MVC.Intranet.Areas.ValidacionVTEAVTP.Controllers
{
    public class PruebaServicioController : BaseController
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            List<VtpVersionDTO> lstVerionesVtp = await validacionVTEAVTPAppServicio.ObtenerSmeVtpVersions("2025.Marzo", "", rutaUpload, base.PathFiles, Helper.ConstantesValidacionVTEAVTP.FolderLog);
            List<VteaVersionDTO> lstVerionesVtea = await validacionVTEAVTPAppServicio.ObtenerSmeVteaVersions("2025.Marzo", "", rutaUpload, base.PathFiles, Helper.ConstantesValidacionVTEAVTP.FolderLog);
            VtpDTO vtp = await validacionVTEAVTPAppServicio.FuncionVtp("2025.Marzo", "Revisión 01", rutaUpload, base.PathFiles, Helper.ConstantesValidacionVTEAVTP.FolderLog);
            VtpValidacionDTO valiacion = await validacionVTEAVTPAppServicio.FuncionVtpValidar("2025.Marzo", "", rutaUpload, base.PathFiles, Helper.ConstantesValidacionVTEAVTP.FolderLog);
            VtpVteaDTO vtpVtea = await validacionVTEAVTPAppServicio.FuncionVtpVtea("2025.Marzo", "", "", rutaUpload, base.PathFiles, Helper.ConstantesValidacionVTEAVTP.FolderLog);
