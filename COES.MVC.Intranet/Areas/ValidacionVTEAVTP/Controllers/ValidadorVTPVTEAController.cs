    ...
    public class ValidadorVTPVTEAController : BaseController
    {
        ...
        public ActionResult CargarReporteConsolidadoHtml(int periodo, int version, int inicializar)
        {
            try
            {
                ...
                string htmlBarrasBrg = RenderRazorViewToString($"{rutaBaseVista}ListaComparacionDiferencias.cshtml", model);
                string htmlBarrasNoBrg = RenderRazorViewToString($"{rutaBaseVista}ListaComparacionVTEA.cshtml", model);
                string htmlBarrasSinAnalizar = RenderRazorViewToString($"{rutaBaseVista}ListaComparacionVTP.cshtml", model);               
