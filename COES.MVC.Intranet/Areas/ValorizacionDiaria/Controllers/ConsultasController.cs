...
namespace COES.MVC.Intranet.Areas.ValorizacionDiaria.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                model.Empresa = servicio.ObtenerEmpresasMME(); //,.ObtenerEmpresas(3);
        ...
        public virtual ActionResult ExportarReporteME()
        {
            ...
            nombreArchivo = ConstantesValorizacionDiaria.NombreReporteMontoPorEnergia;
            string ruta = AppDomain.CurrentDomain.BaseDirectory + ConstantesValorizacionDiaria.FolderReporte;
        ...
        {
            string nombreArchivo = string.Empty;
            nombreArchivo = ConstantesValorizacionDiaria.NombreReporteMontoPorPeaje;
            string ruta = AppDomain.CurrentDomain.BaseDirectory + ConstantesValorizacionDiaria.FolderReporte;
            string fullPath = ruta + nombreArchivo;
            return File(fullPath, Constantes.AppExcel, nombreArchivo);
        }
        ...
        {
            string nombreArchivo = string.Empty;
            nombreArchivo = ConstantesValorizacionDiaria.NombreReporteMontoSCeIO;
            string ruta = AppDomain.CurrentDomain.BaseDirectory + ConstantesValorizacionDiaria.FolderReporte;
            string fullPath = ruta + nombreArchivo;
            return File(fullPath, Constantes.AppExcel, nombreArchivo);
        }
        ...
        {
            string nombreArchivo = string.Empty;
            nombreArchivo = ConstantesValorizacionDiaria.NombreReporteValorizacionDiaria;
            string ruta = AppDomain.CurrentDomain.BaseDirectory + ConstantesValorizacionDiaria.FolderReporte;
            string fullPath = ruta + nombreArchivo;
            return File(fullPath, Constantes.AppExcel, nombreArchivo);
        }
        ...
        public ActionResult IndexReporteInformacionPrevista()
        {
            ...
            ConsultasModel model = new ConsultasModel
            {
                Empresa = servicio.ObtenerEmpresasMME()
            };
            return View(model);
        }
        ...
        {
            string nombreArchivo = string.Empty;
            nombreArchivo = ConstantesValorizacionDiaria.NombreReporteInformacionPrevista;
            string ruta = AppDomain.CurrentDomain.BaseDirectory + ConstantesValorizacionDiaria.FolderReporte;
            string fullPath = ruta + nombreArchivo;
            return File(fullPath, Constantes.AppExcel, nombreArchivo);
        }
        ...
        public FormatoModel BuildHojaExcel(int idEmpresa, DateTime fechaInicio, DateTime fechaFinal, int idformato)
        {
            ...
            MeFormatoDTO formato = new MeFormatoDTO()
            {
                ...
                Formatresolucion = 15,
                Formatperiodo = (idformato == ConstantesValorizacionDiaria.EPRFORMATODIARIO) ? 1 : 6,
        ...
        {
            string ruta = AppDomain.CurrentDomain.BaseDirectory + ConstantesValorizacionDiaria.FolderReporte;
            string fullPath = ruta + ConstantesValorizacionDiaria.NombreReporteInformacionPrevista;
            return File(fullPath, Constantes.AppExcel, ConstantesValorizacionDiaria.NombreReporteInformacionPrevista);
        }
        #endregion
    }
}
