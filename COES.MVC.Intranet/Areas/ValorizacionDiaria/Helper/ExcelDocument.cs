...
namespace COES.MVC.Intranet.Areas.ValorizacionDiaria.Helper
{
    public class ExcelDocument
    {
        ...
        {
            FileInfo template = new FileInfo(ruta + ConstantesValorizacionDiaria.PlantillaExcelMontoPorEnergia);
            FileInfo newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoPorEnergia);
            List<VtdMontoPorEnergiaDTO> list = model.MontoPorEnergia;
            if (newFile.Exists)
            {
                newFile.Delete();
                newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoPorEnergia);
            }
        ...
        {
            FileInfo template = new FileInfo(ruta + ConstantesValorizacionDiaria.PlantillaExcelMontoPoCapacidad);
            FileInfo newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoPorCapacidad);
            List<VtdMontoPorCapacidadDTO> list = model.MontoPorCapacidad;
            if (newFile.Exists)
            {
                newFile.Delete();
                newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoPorCapacidad);
            }
        ...
        {
            FileInfo template = new FileInfo(ruta + ConstantesValorizacionDiaria.PlantillaExcelMontoPorPeaje);
            FileInfo newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoPorPeaje);
            List<VtdMontoPorPeajeDTO> list = model.MontoPorPeaje;
            if (newFile.Exists)
            {
                newFile.Delete();
                newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoPorPeaje);
            }
        ...
        {
            FileInfo template = new FileInfo(ruta + ConstantesValorizacionDiaria.PlantillaExcelMontoPorExceso);
            FileInfo newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoPorExceso);
            List<VtdMontoPorExcesoDTO> list = model.MontoPorExceso;
            if (newFile.Exists)
            {
                newFile.Delete();
                newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoPorExceso);
            }
        ...
        public static void ConfiguracionHojaExcelSCeIO(ExcelWorksheet ws, List<VtdMontoSCeIODTO> lista)
        {
            ...
            ws.Cells[5, 10].Value = "RA (S/)";
            ws.Cells[5, 11].Value = "RA Sub (MW-dia)";
            ws.Cells[5, 12].Value = "RA Baj (MW-dia)";
            ws.Cells[5, 13].Value = "Demanda MW COES";
            ws.Cells[5, 14].Value = "Factor de Reparto";
            ws.Cells[5, 15].Value = "Comp. Costo Ope S/.";
            ws.Cells[5, 16].Value = "Of max Sub (S//MW-mes)";
            ws.Cells[5, 17].Value = "Of max Baj (S//MW-mes)";
        ...
        {
            FileInfo template = new FileInfo(ruta + ConstantesValorizacionDiaria.PlantillaExcelMontoSCeIO);
            FileInfo newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoSCeIO);
            List<VtdMontoSCeIODTO> list = model.MontoSCeIO;
            if (newFile.Exists)
            {
                newFile.Delete();
                newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteMontoSCeIO);
            }
        ...
        {
            FileInfo template = new FileInfo(ruta + ConstantesValorizacionDiaria.PlantillaExcelValorizacionDiaria);
            FileInfo newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteValorizacionDiaria);
            List<ValorizacionDiariaDTO> list = model.ValorizacionDiaria;
            List<ValorizacionDiariaDTO> listmes = model.ValorizacionDiariaMes;
            if (newFile.Exists)
            {
                newFile.Delete();
                newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteValorizacionDiaria);
            }
        ...
        {
            FileInfo template = new FileInfo(ruta + ConstantesValorizacionDiaria.PlantillaExcelReporteInformacionPrevista);
            FileInfo newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteInformacionPrevista);
            List<MeMedicion96DTO> list = model.InformacionPrevista;
            if (newFile.Exists)
            {
                newFile.Delete();
                newFile = new FileInfo(ruta + ConstantesValorizacionDiaria.NombreReporteInformacionPrevista);
            }
