...
var IMG_DETALLES = '<img src="' + siteRoot + 'Content/Images/btn-properties.png" title="Relacionar con MO" width="19" height="19" style="">';
...
function eliminarRecurso(id) {
    if (confirm('¿Está seguro de eliminar el registro de disponibilidad de combustible?')) {
...
function generarHtmlDuplicarRecurso() {
    ...
    var html = `
        ...
        <div class="popup-title">
            <span>Duplicar restricción de Disponibilidad de Combustible</span>
        </div>
