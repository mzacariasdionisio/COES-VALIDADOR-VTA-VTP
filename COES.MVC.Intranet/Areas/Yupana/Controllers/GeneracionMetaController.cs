...
{
    public class GeneracionMetaController : BaseController
    {
        ...
        public JsonResult CargarRestricciones(int formato, string fecha, string semana)
        {
            ...
            try
            {
                ...
                int formatoVentana = servicioYup.ObtenerFormatoSegunVentana(formato, ConstantesYupana.TipoRestriccionGenMeta);

                if (formatoVentana != ConstantesYupana.FormatoGenMetaSemanal) // diario reprograma
                ...
                DatoRestricciones data = servicioYup.ObtenerDatosRestriccionesGenMeta(formatoVentana, fechaProceso);

                model.DataRestricciones = data;
                model.IdEnvio = data.IdEnvio;
                model.ListaEnvios = servicioYup.ObtenerListadoEnvios(formatoVentana, fechaProceso, ConstantesYupana.TipoRestriccionGenMeta);
        ...
        public JsonResult MostrarEnvio(int idEnvio)
        {
            ...
            try
            {
                ...
                //carga listado de restricciones para el handson
                DatoRestricciones data = servicioYup.ObtenerDatosRestriccionesGenMetaPorEnvio(idEnvio);
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult guardarDatos(int horizonte, string fecha, string semana, DatoRestriccionesWeb datosAGuardar)
        {
            ...
            try
            {
                ...
                int formatoVentana = servicioYup.ObtenerFormatoSegunVentana(horizonte, ConstantesYupana.TipoRestriccionGenMeta);
                ...
                {
                    var codeEnvio = servicioYup.GuardarDatosRest(formatoVentana, fechaProceso, datosAGuardar, ConstantesYupana.TipoRestriccionGenMeta, base.UserName);
        ...
        /// </summary>
        /// <param name="fechaVentana"></param>
        /// <param name="caso"></param>
        /// <param name="horizonteC"></param>
        /// <param name="fechaC"></param>
        /// <param name="anioC"></param>
        /// <param name="semanaC"></param>
        /// <param name="fechaOriIniC"></param>
        /// <param name="fechaOriFinC"></param>
        /// <param name="fechaDestIniC"></param>
        /// <param name="fechaDestFinC"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult CopiarDatosGM(string fechaVentana, int caso, int horizonteC, string fechaC, string anioC, string semanaC, string fechaOriIniC, string fechaOriFinC, string fechaDestIniC, string fechaDestFinC)
        {
            ...
            try
            {
                ...
                int formatoVentana = servicioYup.ObtenerFormatoSegunVentana(horizonteC, ConstantesYupana.TipoRestriccionGenMeta);
                ...
                //carga listado de restricciones para el handson
                DatoRestricciones data = servicioYup.ObtenerDatosRestriccionesCopiar(fechaVentana, formatoVentana, fechaProceso, ConstantesYupana.TipoRestriccionGenMeta, fechaOriIniC, fechaOriFinC, fechaDestIniC, fechaDestFinC, caso);
        ...
        public JsonResult ListarEntidadXTipo()
        {
            ...
            {
                base.ValidarSesionJsonResult();
                model.Recursos = servicioYup.ObtenerRecursos(ConstantesYupana.TipoRestriccionGenMeta);
                model.Resultado = "1";
            }
            catch (Exception ex)
            {
        ...
        public JsonResult GuardarRecurso(int rescfgcodi, string nombre)
        {
            ...
            try
            {
                ...
                List<PrRestricCfgDTO> listadoRecursos = servicioYup.GetByCriteriaPrRestricCfgs(ConstantesYupana.TipoRestriccionGenMeta.ToString());
                listadoRecursos = listadoRecursos.Where(x => x.Rescfgestado == ConstantesAppServicio.Activo).ToList();
                var listadoValid = listadoRecursos.Where(x => x.Restipcodi == ConstantesYupana.TipoRestriccionGenMeta && x.Rescfgcodi != rescfgcodi).ToList();

                //Valido que no exista duplicados
                PrRestricCfgDTO duplicado = listadoValid.Find(x => x.Rescfgnombre.Trim() == nombre.Trim());
                if (duplicado != null)
                    throw new ArgumentException("Ya existe un registro de Generación Meta con el mismo nombre ingresado.");
                ...
                if (rescfgcodi == 0)  //Guarda Nuevo
                {
                    ...
                    model.Recurso.Restipcodi = ConstantesYupana.TipoRestriccionGenMeta;
        ...
        public JsonResult ListarModosRelacionados(int rescfgcodi)
        {
            ...
            try
            {
                ...
                List<PrRestricCfgDTO> listaUnidadesHidro = servicioYup.ObtenerRecursos(ConstantesYupana.TipoHidro);
                ...
                model.HidroGenerales = servicioYup.ListarModosGeneral(rescfgcodi, listaUnidadesHidro);
                ...
                model.RecursosHidro = servicioYup.ObtenerRelaciones(rescfgcodi, listaUnidadesHidro);
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult GuardarDatoYRelaciones(string nombre, int rescfgcodi, List<PrRestricCfgdetDTO> listaRelacionesHidro, List<PrRestricCfgdetDTO> listaRelacionesTermo)
        {
            RestriccionModel model = new RestriccionModel();
            model.Recurso = new PrRestricCfgDTO();
            try
            {
                ...
                if (listaRelacionesHidro != null && listaRelacionesHidro.Any())
                {
                    listaRelacionesHidro.ForEach(item => item.Resdetfuente = "E");
                    listaRelaciones.AddRange(listaRelacionesHidro);
                }
                ...
                string msgValidacion = servicioYup.ValidarRestriccion(nombre, rescfgcodi, listadoRecursos, listaRelacionesHidro, listaRelacionesTermo, ConstantesYupana.TipoRestriccionGenMeta, listaRelaciones);
                if (msgValidacion != "")
        ...
        public JsonResult ExportarRestriccion()
        {
            ...
            try
            {
                ...
                string fileName = ConstantesYupana.NombrePlantillaExcelRestriccionGM;
                ...
                servicioYup.GenerarExcelRestriccionGM(pathDestino, fileName);
        ...
        public JsonResult ImportarRestriccionesExcel(string fileName)
        {
            ...
            try
            {
                ...
                DatoRestricciones data = servicioYup.LeerExcelPerfilGM(path, this.NombreFile, base.UserName);
                model.DataRestricciones = data;
                model.Resultado = "1";
            }
            catch (Exception ex)
