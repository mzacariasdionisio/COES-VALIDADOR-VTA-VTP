...
function convertStringCompletoToDate(fecha, horas) {
...
//convierte cadena de texto fecha(dd/mm/yyyy) y horas(hh:mm:ss) a tipo Date
function convertStringToDate(fecha) {
    var partsFecha = fecha.split('/');
    return new Date(partsFecha[2], partsFecha[1] - 1, partsFecha[0]);
}