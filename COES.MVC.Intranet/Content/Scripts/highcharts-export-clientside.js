    ...
    */
    Highcharts.Chart.prototype.viewData = function () {
        if (!this.dataTableDiv) {
            ...
            this.dataTableDiv.className = 'highcharts-data-table grafica-detalle';
            ...
            document.querySelector('.grafica-detalle').remove();
        }
    ...
    Highcharts.Chart.prototype.getTable = function (useLocalDecimalPoint) {
        //variable estatica que no sera modificada en runtime
        ...
        var idElement = this.renderTo.id;

        var typeView = document.getElementById(idElement).getAttribute('data-chart-view');
            ...
            for (j = 0; j < row.length; j = j + 1) {
                ...
                if (typeof val === 'number') {
                    ...
                    if (i == 0 && val === 'DateTime') {
                        ...
                        if (typeView != null && i > 0) {
                            var fecha = new Date(Date.parse(val));
                            if (typeView == 'month') {
                                val = " " + monthNames[fecha.getMonth()].toString() + ' - ' + fecha.getFullYear().toString().substr(-2);
                           
                            } else if (typeView == 'hour') {
                                val = fecha.getHours() + ':' + fecha.getMinutes() + ':' + fecha.getSeconds()
                            }
