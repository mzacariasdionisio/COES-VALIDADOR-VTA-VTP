        ...
        if (hijo.Famcodi != null) {
            ...
            if (listaEquipo_.length > 0) {
                ...
                if (listaEquipo_.length > 5 && TIPO_EQ_FICHA_SELECCIONADO == 1) {
                    clasever = "mas";
                    htmlVermasmenos = `<label href="#" class="${clasever}" onclick="verFilasTabla(this, ${hijo.Famcodi});"  id="vermasmenos_${contadorEquipo++}" >Ver más</label>`;
                }
                ...
                /*<div class="tabla_hijo titulo">${nombreListaEquipo}</div>*/
                htmlHijo += `<div class="coes-box mt-3 mb-3"><div class="coes-box--header-no-content coes-box--header--left-aligned">
                    <h3 class="coes-box--title tabla_hijo titulo">
                       ${nombreListaEquipo}
                    </h3></div></div>
                         <div style="height:auto; width: 800px; margin: 0 auto;">
                        <table class="tabla_hijo tabla-icono ${clasehijosEq}" id="hijoeq_${hijo.Famcodi}" style="width: 800px;">
                        ${htmlVermasmenos}
                             <thead>
                                <tr>
                ...
                for (var j = 0; j < listaEquipo_.length; j++) {
                    ...
                    //SI ESTÁ OCULTO NO LO CONSIDERA
                    ...
                    ${htmlTdEmpresa}
                    <td>
                        <a class="coes-button coes-button--plain-text" href="javascript:verDetalle('${hijo.Fteqcodi}', '${equipo.Equicodi}');">Ver Contenido</a>
                    </td>
                    </tr>
                `;
                }
            ...
            if (listaGrupo_.length > 0) {
                ...
                if (listaGrupo_.length > 5 && TIPO_EQ_FICHA_SELECCIONADO == 1) {
                    clasever = "mas";
                    htmlVermasmenosGrupo = `<label href="#" class="${clasever}" onclick="verFilasTabla(this, ${hijo.Catecodi});"  id="vermasmenosgr_${contadorGrupo++}" >Ver más</label>`;
                }
                /*<div class="tabla_hijo titulo">${nombreListaGrupo}</div>*/
                htmlHijo += `<div class="coes-box mt-3 mb-3"><div class="coes-box--header-no-content coes-box--header--left-aligned">
                    <h3 class="coes-box--title tabla_hijo titulo">
                        ${nombreListaGrupo}
                    </h3></div></div>
                         <div style="height:auto; width: 800px; margin: 0 auto;">
                        <table class="tabla_hijo tabla-icono ${clasehijoGr}" id="hijoeq_${hijo.Catecodi}" style="width: 800px;">
                ...
                for (var k = 0; k < listaGrupo_.length; k++) {
                    ...
                    <td>
                        <a class="coes-button coes-button--plain-text" href="javascript:verDetalle('${hijo.Fteqcodi}', '${grupo.Grupocodi}');">Ver Contenido</a>
                    </td>
                    </tr>
                `;
                }
