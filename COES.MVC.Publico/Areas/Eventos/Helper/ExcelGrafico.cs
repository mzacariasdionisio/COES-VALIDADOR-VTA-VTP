...
namespace COES.MVC.Publico.Areas.Eventos.Helper
{
    public class ExcelGrafico
    {
        ...
        public static void GernerarArchivoMantenimiento(MantenimientoModel model)
        {
            string ruta = ConfigurationManager.AppSettings[RutaDirectorio.ReporteEvento].ToString();
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(newFile))
            {
                ...
                foreach (var reg in model.ListaManttos)
                {
