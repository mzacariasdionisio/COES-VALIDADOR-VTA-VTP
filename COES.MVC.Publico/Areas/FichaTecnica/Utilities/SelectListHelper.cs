...
namespace COES.MVC.Publico.Areas.FichaTecnica.Utilities
{
    public class SelectListHelper
    {
        public static SelectList SelectList(IList lstItems, string dataValueField, string dataTextField, bool tieneSel = true, bool tieneTodos = false, object selectedValue=null)
        {
            SelectList resultSlst = null;
            bool esVacio = lstItems == null || lstItems.Count == 0;
            if (!esVacio)
            {
                ...
                {
                    resultSlst = new SelectList(alstItems, dataValueField, dataTextField, selectedValue);
                }
            }
            else
            {
                ...
                {
                    return new SelectList(lstOpciones, "Valor", "Descripcion",selectedValue);
                }
            }
            return resultSlst;
        }
