...
{
    public class CostoMarginalRealAppServicio
    {
        /// <summary>
        /// Instancia para el manejo de logs
        /// </summary>
        private static readonly ILog Logger = LogManager.GetLogger(typeof(CostoMarginalRealAppServicio));
        ...
        /// </summary>
        public List<PsuDesvcmgsncDTO> GetByCriteriaPsuDesvcmgsncs(DateTime fechaMes)
        {
            return FactorySic.GetPsuDesvcmgsncRepository().GetByCriteria(fechaMes);
        }
