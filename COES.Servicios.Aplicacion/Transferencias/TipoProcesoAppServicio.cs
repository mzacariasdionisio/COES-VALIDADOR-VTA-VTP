...
{
    public class TipoProcesoAppServicio: AppServicioBase
    {
        private static readonly ILog Logger = LogManager.GetLogger(typeof(TipoProcesoAppServicio));
        /// <summary>
        ...
        {
            return FactoryTransferencia.GetVtpTipoProcesoRepository().ListTipoProceso(tipaplicodi);
        }
    }
}
