...
using COES.WebService.CostosMarginalesNodales.Contratos;
using COES.Servicios.Aplicacion.OperacionesVarias;
using System.Globalization;
using COES.WebService.CostosMarginalesNodales.Models;
...
namespace COES.WebService.CostosMarginalesNodales.Servicios
{
    /// <summary>
