...
using COES.WebService.DemandaPr16.Contratos;
using COES.Dominio.DTO.Sic;
using log4net;
using COES.Servicios.Aplicacion.DemandaMaxima;
using System.Net;
using COES.Servicios.Aplicacion.Mediciones;
using COES.WebService.DemandaPr16.Resultados;
using COES.WebService.DemandaPr16.SeguridadServicio;

namespace COES.WebService.DemandaPr16.Servicios
{
    /// <summary>
    /// 
    /// </summary>
