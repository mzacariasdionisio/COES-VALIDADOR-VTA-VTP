...
using COES.WebService.Digsilent.Contratos;
using COES.WebService.Digsilent.Models;

namespace COES.WebService.Digsilent.Servicios
{
    [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Single, InstanceContextMode = InstanceContextMode.PerSession)]
    public class DigsilentServicio : IDigsilentServicio
    {
        private static readonly ILog log = log4net.LogManager.GetLogger(typeof(DigsilentServicio));
