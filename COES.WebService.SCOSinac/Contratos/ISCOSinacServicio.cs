...
namespace COES.WebService.SCOSinac.Contratos
{
    ...
    public interface ISCOSinacServicio
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json, UriTemplate = "ListaScoSinacGetParametrosGeneralesCV")]
        List<AddInParametroGeneral> ListaScoSinacGetParametrosGeneralesCV(CVDataRequest data);

        [OperationContract]
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json, UriTemplate = "ListaScoSinacGetParametrosModoCV")]
        DatoModo ListaScoSinacGetParametrosModoCV(CVDataRequest data);
    ...
    public class DatoModo
    {
        public string StrConceptosInvalidos { get; set; }
        public List<AddInColModo> FilasModo { get; set; }
    }
